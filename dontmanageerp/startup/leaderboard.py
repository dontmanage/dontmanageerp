...
def get_leaderboards():
	leaderboards = {
		"Customer": {
			...
			"method": "dontmanageerp.startup.leaderboard.get_all_customers",
			"icon": "customer",
		},
		"Item": {
			"fields": [
			...
			"method": "dontmanageerp.startup.leaderboard.get_all_items",
			"icon": "stock",
		},
		"Supplier": {
			"fields": [
			...
			"method": "dontmanageerp.startup.leaderboard.get_all_suppliers",
			"icon": "buying",
		},
		"Sales Partner": {
			"fields": [
			...
			"method": "dontmanageerp.startup.leaderboard.get_all_sales_partner",
			"icon": "hr",
		},
		"Sales Person": {
			"fields": [{"fieldname": "total_sales_amount", "fieldtype": "Currency"}],
			"method": "dontmanageerp.startup.leaderboard.get_all_sales_person",
			"icon": "customer",
		},
	}
...
def get_all_items(date_range, company, field, limit=None):
	if field in ("available_stock_qty", "available_stock_value"):
		...
		readable_active_items = set(dontmanage.get_list("Item", filters={"disabled": 0}, pluck="name"))
...
def get_date_condition(date_range, field):
	...
	if date_range:
		...
		date_condition = f"and {field} between {dontmanage.db.escape(from_date)} and {dontmanage.db.escape(to_date)}"
