...
import dontmanage
from dontmanage.utils import add_months, add_to_date, now_datetime, nowdate

from dontmanageerp.accounts.doctype.sales_invoice.test_sales_invoice import create_sales_invoice
from dontmanageerp.projects.doctype.timesheet.timesheet import OverlapError, make_sales_invoice
from dontmanageerp.setup.doctype.employee.test_employee import make_employee


class TestTimesheet(unittest.TestCase):
	def setUp(self):
		dontmanage.db.delete("Timesheet")
	...
	def test_timesheet_billing_based_on_project(self):
		...
		ts = dontmanage.get_doc("Timesheet", timesheet.name)
	...
	def test_timesheet_time_overlap(self):
		...
		timesheet = dontmanage.new_doc("Timesheet")
		...
		self.assertRaises(dontmanage.ValidationError, timesheet.save)
	...
	def test_per_billed_hours(self):
		...
		ts = dontmanage.new_doc("Timesheet")
...
def update_activity_type(activity_type):
	activity_type = dontmanage.get_doc("Activity Type", activity_type)
