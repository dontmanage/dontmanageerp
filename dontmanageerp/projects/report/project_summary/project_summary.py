...
def execute(filters=None):
	...
	for project in data:
		project["total_tasks"] = dontmanage.db.count("Task", filters={"project": project.name})
		project["completed_tasks"] = dontmanage.db.count(
			"Task", filters={"project": project.name, "status": "Completed"}
		)
		project["overdue_tasks"] = dontmanage.db.count(
