...
class TestWebsite(unittest.TestCase):
	def test_permission_for_custom_doctype(self):
		...
		dontmanage.set_user("supplier1@gmail.com")
		...
		dontmanage.set_user("supplier2@gmail.com")
...
def get_data():
	...
	if webform_list_contexts:
		context = dontmanage._dict(dontmanage.get_attr(webform_list_contexts[0])("Buying") or {})
...
def create_supplier_with_contact(name, group, contact_name, contact_email):
	...
	if not dontmanage.db.exists("Contact", contact_name + "-1-" + name):
