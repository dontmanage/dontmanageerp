...
class Prospect(CRMNote):
	...
	if TYPE_CHECKING:
		...
		from dontmanageerp.crm.doctype.prospect_lead.prospect_lead import ProspectLead
		from dontmanageerp.crm.doctype.prospect_opportunity.prospect_opportunity import ProspectOpportunity
...
def make_customer(source_name, target_doc=None):
	def set_missing_values(source, target):
		...
		target.customer_group = source.customer_group or dontmanage.db.get_default("Customer Group")
