...
from dontmanageerp.crm.doctype.lead.lead import add_lead_to_prospect
...
class TestProspect(unittest.TestCase):
	...
	def test_make_customer_from_prospect(self):
		...
		dontmanage.delete_doc_if_exists("Customer", "_Test Prospect")
...
def make_prospect(**args):
	...
	prospect_doc = dontmanage.get_doc(
		{
			"doctype": "Prospect",
...
def make_address(**args):
	...
	address_doc = dontmanage.get_doc(
		{
			"doctype": "Address",
