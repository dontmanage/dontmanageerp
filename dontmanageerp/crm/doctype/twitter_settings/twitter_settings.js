...
dontmanage.ui.form.on('Twitter Settings', {
	onload: function(frm) {
		...
		frm.dashboard.set_headline(__("For more information, {0}.", [`<a target='_blank' href='https://docs.dontmanageerp.com/docs/user/manual/en/CRM/twitter-settings'>${__('Click here')}</a>`]));
	},
