...
def create_test_appointment():
	test_appointment = dontmanage.get_doc(
		{
			"doctype": "Appointment",
			"status": "Open",
...
class TestAppointment(unittest.TestCase):
	def setUpClass():
		dontmanage.db.delete("Lead", {"email_id": LEAD_EMAIL})
	...
	def test_calendar_event_created(self):
		cal_event = dontmanage.get_doc("Event", self.test_appointment.calendar_event)
