...
class OpportunitySummaryBySalesStage(object):
	...
	def set_sales_stage_columns(self):
		self.sales_stage_list = dontmanage.db.get_list("Sales Stage", pluck="name")
	...
	def get_formatted_data(self):
		self.formatted_data = dontmanage._dict()
	...
	def set_formatted_data_based_on_sales_stage(self, based_on, sales_stage, count):
		self.formatted_data.setdefault(based_on, dontmanage._dict()).setdefault(sales_stage, 0)
