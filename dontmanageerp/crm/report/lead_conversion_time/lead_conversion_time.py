...
from dontmanage.utils import date_diff, flt
...
def get_communication_details(filters):
	...
	communication_list = []
	opportunities = dontmanage.db.get_values(
		"Opportunity",
	...
	for d in opportunities:
		...
		communication_count = dontmanage.db.sql(
			"""
				SELECT
					count(*)
				FROM
		...
		first_contact = dontmanage.db.sql(
			"""
				SELECT
		...
		support_tickets = len(dontmanage.db.get_all("Issue", {"raised_by": d.contact_email}))
