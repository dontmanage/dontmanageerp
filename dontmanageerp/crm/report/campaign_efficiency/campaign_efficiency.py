...
def get_columns(based_on):
	return [
		{"fieldname": dontmanage.scrub(based_on), "label": _(based_on), "fieldtype": "Data", "width": 150},
...
def get_lead_data(filters, based_on):
	based_on_field = dontmanage.scrub(based_on)
	conditions = get_filter_conditions(filters)

	lead_details = dontmanage.db.sql(
		"""
