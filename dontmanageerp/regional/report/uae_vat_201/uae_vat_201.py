...
def append_vat_on_sales(data, filters):
	...
	append_data(
		data, "4", _("Zero Rated"), dontmanage.format(get_zero_rated_total(filters), "Currency"), "-"
	)

	append_data(
		data, "5", _("Exempt Supplies"), dontmanage.format(get_exempt_total(filters), "Currency"), "-"
	)
