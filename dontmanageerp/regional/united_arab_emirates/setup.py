...
def add_print_formats():
	dontmanage.reload_doc("regional", "print_format", "detailed_tax_invoice")
	dontmanage.reload_doc("regional", "print_format", "simplified_tax_invoice")
	dontmanage.reload_doc("regional", "print_format", "tax_invoice")
...
def add_custom_roles_for_reports():
	...
	if not dontmanage.db.get_value("Custom Role", dict(report="UAE VAT 201")):
		dontmanage.get_doc(
			dict(
				doctype="Custom Role",
				report="UAE VAT 201",
