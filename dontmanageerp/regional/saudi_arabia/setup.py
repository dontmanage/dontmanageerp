...
from dontmanageerp.regional.saudi_arabia.wizard.operations.setup_ksa_vat_setting import (
...
def add_print_formats():
	dontmanage.reload_doc("regional", "print_format", "detailed_tax_invoice", force=True)
	dontmanage.reload_doc("regional", "print_format", "simplified_tax_invoice", force=True)
	dontmanage.reload_doc("regional", "print_format", "tax_invoice", force=True)
	...
	for d in (
		...
		dontmanage.db.set_value("Print Format", d, "disabled", 0)
...
def add_permissions():
	...
	dontmanage.db.set_value("Report", "KSA VAT", "disabled", 0)
