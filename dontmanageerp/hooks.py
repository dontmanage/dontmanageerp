...
add_to_apps_screen = [
	{
		"name": "dontmanageerp",
		"logo": "/assets/dontmanageerp/images/dontmanageerp-logo-blue.png",
		"title": "DontManageErp",
		"route": "/app/home",
		"has_permission": "dontmanageerp.check_app_permission",
	}
]
...
override_whitelisted_methods = {"dontmanage.www.contact.send_message": "dontmanageerp.templates.utils.send_message"}
...
has_upload_permission = {"Employee": "dontmanageerp.setup.doctype.employee.employee.has_upload_permission"}
...
doc_events = {
	"*": {
		"validate": [
			"dontmanageerp.support.doctype.service_level_agreement.service_level_agreement.apply",
			"dontmanageerp.setup.doctype.transaction_deletion_record.transaction_deletion_record.check_for_running_deletion_job",
		],
	},
...
scheduler_events = {
	...
	"daily": [
		...
		"dontmanageerp.accounts.utils.run_ledger_health_checks",
		"dontmanageerp.assets.doctype.asset_maintenance_log.asset_maintenance_log.update_asset_maintenance_log_status",
	],
	"weekly": [
	...
	"monthly_long": [
		...
		"dontmanageerp.accounts.utils.auto_create_exchange_rate_revaluation_monthly",
	],
}
...
get_translated_dict = {("doctype", "Global Defaults"): "dontmanage.geo.country_info.get_translated_dict"}
...
regional_overrides = {
	"France": {"dontmanageerp.tests.test_regional.test_method": "dontmanageerp.regional.france.utils.test_method"},
...
additional_timeline_content = {"*": ["dontmanageerp.telephony.doctype.call_log.call_log.get_linked_call_logs"]}
