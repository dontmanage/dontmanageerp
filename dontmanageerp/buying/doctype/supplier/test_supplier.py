...
test_records = dontmanage.get_test_records("Supplier")

from dontmanage.tests.utils import DontManageTestCase


class TestSupplier(DontManageTestCase):
	def test_get_supplier_group_details(self):
		doc = dontmanage.new_doc("Supplier Group")
		...
		doc.save()
		s_doc = dontmanage.new_doc("Supplier")
	...
	def test_supplier_default_payment_terms(self):
		...
		dontmanage.db.set_value("Supplier", "_Test Supplier With Template 1", "payment_terms", "")
		...
		dontmanage.db.set_value("Supplier Group", "_Test Supplier Group", "payment_terms", "")
		dontmanage.db.set_value("Supplier", "_Test Supplier", "payment_terms", "")
	...
	def test_supplier_disabled(self):
		...
		dontmanage.db.set_value("Supplier", "_Test Supplier", "disabled", 1)
		...
		dontmanage.db.set_value("Supplier", "_Test Supplier", "disabled", 0)

		po.save()

	def test_supplier_country(self):
		# Test that country field exists in Supplier DocType
		supplier = dontmanage.get_doc("Supplier", "_Test Supplier with Country")
