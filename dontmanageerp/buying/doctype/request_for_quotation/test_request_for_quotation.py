...
from dontmanageerp.crm.doctype.opportunity.opportunity import make_request_for_quotation as make_rfq
from dontmanageerp.crm.doctype.opportunity.test_opportunity import make_opportunity
from dontmanageerp.stock.doctype.item.test_item import make_item
from dontmanageerp.templates.pages.rfq import check_supplier_has_docname_access


class TestRequestforQuotation(DontManageTestCase):
	...
	def test_make_supplier_quotation_with_special_characters(self):
		dontmanage.delete_doc_if_exists("Supplier", "_Test Supplier '1", force=1)
	...
	def test_make_supplier_quotation_from_portal(self):
		...
		supplier_quotation_doc = dontmanage.get_doc("Supplier Quotation", supplier_quotation_name)
	...
	def test_make_multi_uom_supplier_quotation(self):
		...
		supplier_quotation_name = create_supplier_quotation(rfq)
		supplier_quotation = dontmanage.get_doc("Supplier Quotation", supplier_quotation_name)
...
def make_request_for_quotation(**args) -> "RequestforQuotation":
	...
	rfq = dontmanage.new_doc("Request for Quotation")
