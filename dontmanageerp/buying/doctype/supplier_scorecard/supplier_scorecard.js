...
/* global dontmanage, refresh_field */

dontmanage.ui.form.on("Supplier Scorecard", {
	setup: function(frm) {
	...
	load_criteria: function(frm) {
		dontmanage.call({
			method: "dontmanageerp.buying.doctype.supplier_scorecard_criteria.supplier_scorecard_criteria.get_criteria_list",
			callback: function(r) {
...
dontmanage.ui.form.on("Supplier Scorecard Scoring Standing", {

	standing_name: function(frm, cdt, cdn) {
		var d = dontmanage.get_doc(cdt, cdn);
		if (d.standing_name) {
			return frm.call({
				method: "dontmanageerp.buying.doctype.supplier_scorecard_standing.supplier_scorecard_standing.get_scoring_standing",
				child: d,
				args: {
...
dontmanage.ui.form.on("Supplier Scorecard Scoring Criteria", {
...
var loadAllStandings = function(frm) {
	dontmanage.call({
		method: "dontmanageerp.buying.doctype.supplier_scorecard_standing.supplier_scorecard_standing.get_standings_list",
		callback: function(r) {
