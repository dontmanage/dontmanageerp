...
class SupplierQuotation(BuyingController):
	...
	if TYPE_CHECKING:
		...
		from dontmanageerp.buying.doctype.supplier_quotation_item.supplier_quotation_item import (
	...
	def update_rfq_supplier_status(self, include_me):
		...
		for rfq in rfq_list:
			doc = dontmanage.get_doc("Request for Quotation", rfq)
			doc_sup = dontmanage.get_all(
	...
	doclist = get_mapped_doc(
		...
		source_name,
		{
			...
			"Supplier Quotation Item": {
				...
				"condition": lambda doc: dontmanage.db.get_value("Item", doc.item_code, "is_sales_item") == 1,
				"add_if_empty": True,
			},
		},
		target_doc,
