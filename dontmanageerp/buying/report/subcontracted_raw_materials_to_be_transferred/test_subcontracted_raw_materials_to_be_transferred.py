...
# Embedded file name: /Users/anuragmishra/dontmanage-develop/apps/dontmanageerp/dontmanageerp/buying/report/subcontracted_raw_materials_to_be_transferred/test_subcontracted_raw_materials_to_be_transferred.py
...
from dontmanageerp.buying.report.subcontracted_raw_materials_to_be_transferred.subcontracted_raw_materials_to_be_transferred import (
	execute,
)
...
class TestSubcontractedItemToBeTransferred(DontManageTestCase):
			...
			filters=dontmanage._dict(
				{
					...
					"from_date": dontmanage.utils.get_datetime(
						dontmanage.utils.add_to_date(sco.transaction_date, days=-10)
					),
					"to_date": dontmanage.utils.get_datetime(dontmanage.utils.add_to_date(sco.transaction_date, days=10)),
				}
			)
		)
		sco.reload()
