...
from dontmanageerp.buying.report.requested_items_to_order_and_receive.requested_items_to_order_and_receive import (
	get_data,
)
...
class TestRequestedItemsToOrderAndReceive(DontManageTestCase):
	def setUp(self) -> None:
