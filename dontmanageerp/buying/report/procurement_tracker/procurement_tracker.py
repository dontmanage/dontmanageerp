...
def get_mapped_mr_details(filters):
	mr_records = {}
	parent = dontmanage.qb.DocType("Material Request")
	child = dontmanage.qb.DocType("Material Request Item")
	...
	for record in mr_details:
		if record.per_ordered:
			mr_records.setdefault(record.name, []).append(dontmanage._dict(record))
		else:
...
def get_mapped_pi_records():
	...
	return dontmanage._dict(pi_records)


def get_mapped_pr_records():
	pr = dontmanage.qb.DocType("Purchase Receipt")
	pr_item = dontmanage.qb.DocType("Purchase Receipt Item")
	pr_records = (
	...
	return dontmanage._dict(pr_records)


def get_po_entries(filters):
	parent = dontmanage.qb.DocType("Purchase Order")
	child = dontmanage.qb.DocType("Purchase Order Item")
