...
def get_supplier_details():
	details = dontmanage.get_all("Supplier", fields=["name", "supplier_name", "supplier_group"])
	supplier_details = {}
	for d in details:
		supplier_details.setdefault(
			d.name,
			dontmanage._dict({"supplier_name": d.supplier_name, "supplier_group": d.supplier_group}),
		)
...
def get_purchase_order_details(company_list, filters):
	db_po = dontmanage.qb.DocType("Purchase Order")
	db_po_item = dontmanage.qb.DocType("Purchase Order Item")

	query = (
		dontmanage.qb.from_(db_po)
