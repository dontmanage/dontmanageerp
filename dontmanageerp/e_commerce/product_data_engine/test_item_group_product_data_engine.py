...
class TestItemGroupProductDataEngine(unittest.TestCase):
	...
	def setUp(self):
		...
		dontmanage.db.set_value("Item Group", "_Test Item Group B - 2", "show_in_website", 1)
	...
	def test_products_in_multiple_item_groups(self):
		...
		website_item = dontmanage.get_doc("Website Item", {"item_code": "Test Mobile E"})
	...
	def test_item_group_with_sub_groups(self):
		...
		dontmanage.db.set_value("Item Group", "_Test Item Group B - 2", "show_in_website", 0)
	...
	def test_item_group_page_with_descendants_included(self):
		...
		dontmanage.db.set_value("Item Group", "_Test Item Group B - 1 - 1", "show_in_website", 1)

		# enable 'include descendants' in Level 1
		dontmanage.db.set_value("Item Group", "_Test Item Group B", "include_descendants", 1)
