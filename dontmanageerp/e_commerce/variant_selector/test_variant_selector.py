...
from dontmanageerp.e_commerce.variant_selector.utils import get_next_attribute_and_values
from dontmanageerp.stock.doctype.item.test_item import make_item

test_dependencies = ["Item"]


class TestVariantSelector(DontManageTestCase):
	@classmethod
	def setUpClass(cls):
		super().setUpClass()
	...
	def test_item_attributes(self):
		...
		"""
		from dontmanageerp.e_commerce.variant_selector.utils import get_attributes_and_values
		...
		small_variant = dontmanage.get_doc("Item", "Test-Tshirt-Temp-S-R")
	...
	def test_exact_match_with_price(self):
		...
		"""
		from dontmanageerp.e_commerce.doctype.website_item.test_website_item import make_web_item_price
		...
		dontmanage.local.shopping_cart_settings = None  # clear cached settings values
		next_values = get_next_attribute_and_values(
