...
def get_item_codes_by_attributes(attribute_filters, template_item_code=None):
	...
	for attribute, values in attribute_filters.items():
		...
		item_codes = set([r[0] for r in dontmanage.db.sql(query, query_values)])  # nosemgrep
...
def get_attributes_and_values(item_code):
	...
	item_attribute_values = dontmanage.db.get_all(
		"Item Attribute Value", ["parent", "attribute_value", "idx"], order_by="parent asc, idx asc"
	)
	ordered_attribute_value_map = dontmanage._dict()
...
def get_next_attribute_and_values(item_code, selected_attributes):
	...
	"""
	selected_attributes = dontmanage.parse_json(selected_attributes)
	...
	valid_options_for_attributes = dontmanage._dict()
	...
	if product_id:
		website_warehouse = dontmanage.get_cached_value(
...
def get_item_attributes(item_code):
	attributes = dontmanage.db.get_all(
