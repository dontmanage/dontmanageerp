...
from dontmanageerp.e_commerce.shopping_cart.cart import _get_cart_quotation, _set_price_list
from dontmanageerp.utilities.product import (
...
def get_product_info_for_website(item_code, skip_quotation_creation=False):
	...
	if not cart_settings.enabled:
		...
		return dontmanage._dict({"product_info": {}, "cart_settings": cart_settings})

	cart_quotation = dontmanage._dict()
	...
	if cart_settings.show_stock_availability:
		on_backorder = dontmanage.get_cached_value("Website Item", {"item_code": item_code}, "on_backorder")
		if on_backorder:
			stock_status = dontmanage._dict({"on_backorder": True})
		else:
	...
	product_info = {
		"price": price,
		"qty": 0,
		"uom": dontmanage.db.get_value("Item", item_code, "stock_uom"),
		"sales_uom": dontmanage.db.get_value("Item", item_code, "sales_uom"),
	}
	...
	return dontmanage._dict({"product_info": product_info, "cart_settings": cart_settings})
