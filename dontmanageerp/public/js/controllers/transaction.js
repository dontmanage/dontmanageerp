...
dontmanageerp.TransactionController = class TransactionController extends dontmanageerp.taxes_and_totals {
	...
	toggle_enable_for_stock_uom(field) {
		dontmanage.db.get_single_value('Stock Settings', field)
		.then(value => {
		...
		var set_pricing = function() {
			if(me.frm.doc.company && me.frm.fields_dict.currency) {
				...
				if (company_doc){
					...
					if (company_doc.default_selling_terms && dontmanage.meta.has_field(me.frm.doc.doctype, "tc_name") &&
					...
					if (company_doc.default_buying_terms && dontmanage.meta.has_field(me.frm.doc.doctype, "tc_name") &&
	...
	change_form_labels(company_currency) {
		...
		if(dontmanage.meta.get_docfield(cur_frm.doctype, "net_total"))
			cur_frm.toggle_display("net_total", show);

		if(dontmanage.meta.get_docfield(cur_frm.doctype, "base_net_total"))
