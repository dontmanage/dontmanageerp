...
dontmanageerp.accounts.bank_reconciliation.DataTableManager = class DataTableManager {
	constructor(opts) {
		Object.assign(this, opts);
		this.dialog_manager = new dontmanageerp.accounts.bank_reconciliation.DialogManager(
			this.company,
			this.bank_account,
	...
	make_dt() {
		var me = this;
		dontmanage.call({
			method: "dontmanageerp.accounts.doctype.bank_reconciliation_tool.bank_reconciliation_tool.get_bank_transactions",
			args: {
	...
	get_datatable() {
		...
		this.datatable = new dontmanage.DataTable(this.$reconciliation_tool_dt.get(0), datatable_options);
