...
dontmanageerp.setup.slides_settings = [
	{
		...
		set_fy_dates: function (slide) {
			...
			if (country) {
				let fy = dontmanageerp.setup.fiscal_years[country];
		...
		load_chart_of_accounts: function (slide) {
			let country = dontmanage.wizard.values.country;
		...
		bind_events: function (slide) {
			...
			}).val(dontmanage.boot.sysdefaults.company_abbr || "").trigger("change");
		},
