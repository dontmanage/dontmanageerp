...
dontmanageerp.setup.slides_settings = [
	{
		...
		bind_events: function (slide) {
			...
			slide.get_input("fy_start_date").on("change", function () {
				...
				var year_end_date = dontmanage.datetime.add_days(dontmanage.datetime.add_months(start_date, 12), -1);
			...
			slide
				...
				.val(dontmanage.boot.sysdefaults.company_name || "")
				.trigger("change");
			...
			slide
				...
				.val(dontmanage.boot.sysdefaults.company_abbr || "")
				.trigger("change");
		},
