...
dontmanage.ui.form.on("Event", {
	refresh: function(frm) {
		...
		frm.add_custom_button(__('Add Leads'), function() {
			new dontmanage.desk.eventParticipants(frm, "Lead");
		}, __("Add Participants"));

		frm.add_custom_button(__('Add Customers'), function() {
			new dontmanage.desk.eventParticipants(frm, "Customer");
		}, __("Add Participants"));

		frm.add_custom_button(__('Add Suppliers'), function() {
			new dontmanage.desk.eventParticipants(frm, "Supplier");
		}, __("Add Participants"));

		frm.add_custom_button(__('Add Employees'), function() {
			new dontmanage.desk.eventParticipants(frm, "Employee");
		}, __("Add Participants"));

		frm.add_custom_button(__('Add Sales Partners'), function() {
			new dontmanage.desk.eventParticipants(frm, "Sales Partners");
		}, __("Add Participants"));
	}
});
