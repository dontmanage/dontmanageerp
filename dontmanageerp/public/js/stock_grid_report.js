...
dontmanageerp.StockGridReport = class StockGridReport extends dontmanage.views.TreeGridReport {
	...
	get_serialized_buying_rates() {
		...
		if (dontmanage.report_dump.data["Serial No"]) {
			$.each(dontmanage.report_dump.data["Serial No"], function(i, sn) {
