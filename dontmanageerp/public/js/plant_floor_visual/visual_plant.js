class VisualPlantFloor {
	...
	prepare_data() {
		dontmanage.call({
			method: 'dontmanageerp.manufacturing.doctype.workstation.workstation.get_workstations',
			args: {
	...
	add_filter() {
		this.plant_floor = dontmanage.ui.form.make_control({
			df: {
				fieldtype: 'Link',
				options: 'Plant Floor',
		...
		this.workstation_type = dontmanage.ui.form.make_control({
			df: {
				fieldtype: 'Link',
		...
		this.workstation = dontmanage.ui.form.make_control({
			df: {
				fieldtype: 'Link',
				options: 'Workstation',
		...
		this.workstation_status = dontmanage.ui.form.make_control({
			df: {
				fieldtype: 'Select',
				options: '\nProduction\nOff\nIdle\nProblem\nMaintenance\nSetup',
	...
	render_workstations() {
		...
		let template  = dontmanage.render_template("visual_plant_floor_template", {
...
dontmanage.ui.VisualPlantFloor = VisualPlantFloor;