...
dontmanageerp.payments = class payments extends dontmanageerp.stock.StockController {
	make_payment() {
		var me = this;
	...
	make_keyboard(){
		var me = this;
		$(this.$body).empty();
		$(this.$body).html(dontmanage.render_template('pos_payment', this.frm.doc))
	...
	make_multimode_payment(){
		...
		this.payments = dontmanage.model.add_child(this.frm.doc, 'Multi Mode Payment', "payments");
	...
	show_payment_details(){
		...
		if (this.frm.doc.payments.length) {
			$.each(this.frm.doc.payments, function(index, data) {
				$(dontmanage.render_template('payment_details', {
	...
	show_amounts(){
		...
		$(this.$body).find('.outstanding_amount').text(format_currency(this.frm.doc.outstanding_amount, dontmanage.get_doc(":Company", this.frm.doc.company).default_currency));
		this.update_invoice();
	}
}
