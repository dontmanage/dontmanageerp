dontmanage.provide("dontmanage.help.help_links");

const docsUrl = "https://dontmanageerp.com/docs/";

dontmanage.help.help_links["Form/Rename Tool"] = [
	{
		label: "Bulk Rename",
		url: docsUrl + "user/manual/en/using-dontmanageerp/articles/bulk-rename",
	},
];

//Setup

dontmanage.help.help_links["List/User"] = [
	{
		label: "New User",
		url:
			docsUrl +
...
dontmanage.help.help_links["permission-manager"] = [
	{
...
dontmanage.help.help_links["Form/System Settings"] = [
	{
...
dontmanage.help.help_links["Form/Data Import"] = [
	{
...
dontmanage.help.help_links["List/Data Import"] = [
	{
		label: "Importing and Exporting Data",
		url: docsUrl + "user/manual/en/setting-up/data/data-import",
	},
...
dontmanage.help.help_links["module_setup"] = [
	{
		label: "Role Permissions Manager",
		url:
			docsUrl +
...
dontmanage.help.help_links["Form/Naming Series"] = [
	{
		label: "Naming Series",
...
dontmanage.help.help_links["Form/Global Defaults"] = [
	{
...
dontmanage.help.help_links["List/Print Heading"] = [
	{
		label: "Print Heading",
...
dontmanage.help.help_links["Form/Print Heading"] = [
	{
		label: "Print Heading",
		url: docsUrl + "user/manual/en/setting-up/print/print-headings",
	},
...
dontmanage.help.help_links["List/Letter Head"] = [
	{
		label: "Letter Head",
...
dontmanage.help.help_links["List/Address Template"] = [
	{
...
dontmanage.help.help_links["List/Terms and Conditions"] = [
	{
...
dontmanage.help.help_links["List/Cheque Print Template"] = [
	{
...
dontmanage.help.help_links["List/Email Account"] = [
	{
		label: "Email Account",
...
dontmanage.help.help_links["List/Notification"] = [
	{
		label: "Notification",
...
dontmanage.help.help_links["Form/Notification"] = [
	{
		label: "Notification",
		url: docsUrl + "user/manual/en/setting-up/notifications",
	},
...
dontmanage.help.help_links["Form/Email Digest"] = [
	{
		label: "Email Digest",
...
dontmanage.help.help_links["List/Auto Email Report"] = [
	{
...
dontmanage.help.help_links["Form/Print Settings"] = [
	{
...
dontmanage.help.help_links["print-format-builder"] = [
	{
...
dontmanage.help.help_links["Form/PayPal Settings"] = [
	{
		label: "PayPal Settings",
		url:
			docsUrl +
			"user/manual/en/dontmanageerp_integration/paypal-integration",
	},
];

dontmanage.help.help_links["Form/Razorpay Settings"] = [
	{
		label: "Razorpay Settings",
		url:
			docsUrl +
			"user/manual/en/dontmanageerp_integration/razorpay-integration",
	},
];

dontmanage.help.help_links["Form/Dropbox Settings"] = [
	{
		label: "Dropbox Settings",
		url: docsUrl + "user/manual/en/dontmanageerp_integration/dropbox-backup",
	},
];

dontmanage.help.help_links["Form/LDAP Settings"] = [
	{
		label: "LDAP Settings",
		url:
			docsUrl + "user/manual/en/dontmanageerp_integration/ldap-integration",
	},
];

dontmanage.help.help_links["Form/Stripe Settings"] = [
	{
		label: "Stripe Settings",
		url:
			docsUrl +
			"user/manual/en/dontmanageerp_integration/stripe-integration",
	},
];

//Sales

dontmanage.help.help_links["Form/Quotation"] = [
...
dontmanage.help.help_links["List/Customer"] = [
...
dontmanage.help.help_links["Form/Customer"] = [
	{ label: "Customer", url: docsUrl + "user/manual/en/CRM/customer" },
	{
		label: "Credit Limit",
		url: docsUrl + "user/manual/en/accounts/credit-limit",
...
dontmanage.help.help_links["List/Sales Taxes and Charges Template"] = [
	{
...
dontmanage.help.help_links["Form/Sales Taxes and Charges Template"] = [
	{
		label: "Setting Up Taxes",
		url: docsUrl + "user/manual/en/setting-up/setting-up-taxes",
	},
...
dontmanage.help.help_links["List/Sales Order"] = [
	{
		label: "Sales Order",
...
dontmanage.help.help_links["Form/Sales Order"] = [
	{
		label: "Sales Order",
		url: docsUrl + "user/manual/en/selling/sales-order",
	},
...
dontmanage.help.help_links["Form/Product Bundle"] = [
	{
...
dontmanage.help.help_links["Form/Selling Settings"] = [
	{
...
dontmanage.help.help_links["List/Supplier"] = [
	{ label: "Supplier", url: docsUrl + "user/manual/en/buying/supplier" },
];

dontmanage.help.help_links["Form/Supplier"] = [
	{ label: "Supplier", url: docsUrl + "user/manual/en/buying/supplier" },
];

dontmanage.help.help_links["Form/Request for Quotation"] = [
	{
...
dontmanage.help.help_links["Form/Supplier Quotation"] = [
	{
...
dontmanage.help.help_links["Form/Buying Settings"] = [
	{
...
dontmanage.help.help_links["List/Purchase Order"] = [
	{
...
dontmanage.help.help_links["Form/Purchase Order"] = [
	{
		label: "Purchase Order",
		url: docsUrl + "user/manual/en/buying/purchase-order",
	},
...
dontmanage.help.help_links["List/Purchase Taxes and Charges Template"] = [
	{
		label: "Setting Up Taxes",
		url: docsUrl + "user/manual/en/setting-up/setting-up-taxes",
	},
...
dontmanage.help.help_links["List/Price List"] = [
	{
		label: "Price List",
...
dontmanage.help.help_links["List/Authorization Rule"] = [
	{
		label: "Authorization Rule",
		url: docsUrl + "user/manual/en/customize-dontmanageerp/authorization-rule",
	},
];

dontmanage.help.help_links["Form/SMS Settings"] = [
	{
		label: "SMS Settings",
...
dontmanage.help.help_links["List/Stock Reconciliation"] = [
	{
...
dontmanage.help.help_links["Tree/Territory"] = [
	{
		label: "Territory",
...
dontmanage.help.help_links["List/Workflow"] = [
	{ label: "Workflow", url: docsUrl + "user/manual/en/setting-up/workflows" },
];

dontmanage.help.help_links["List/Company"] = [
	{
		label: "Company",
...
dontmanage.help.help_links["Tree/Account"] = [
	{
...
dontmanage.help.help_links["Form/Sales Invoice"] = [
	{
		label: "Sales Invoice",
...
dontmanage.help.help_links["List/Sales Invoice"] = [
	{
		label: "Sales Invoice",
		url: docsUrl + "user/manual/en/accounts/sales-invoice",
	},
...
dontmanage.help.help_links["point-of-sale"] = [
	{
...
dontmanage.help.help_links["List/POS Profile"] = [
	{
...
dontmanage.help.help_links["Form/POS Profile"] = [
	{
		label: "POS Profile",
		url: docsUrl + "user/manual/en/accounts/pos-profile",
	},
...
dontmanage.help.help_links["List/Purchase Invoice"] = [
	{
...
dontmanage.help.help_links["List/Journal Entry"] = [
	{
		label: "Journal Entry",
...
dontmanage.help.help_links["List/Payment Entry"] = [
	{
		label: "Payment Entry",
...
dontmanage.help.help_links["List/Payment Request"] = [
	{
...
dontmanage.help.help_links["List/Asset"] = [
	{
...
dontmanage.help.help_links["List/Asset Category"] = [
	{
...
dontmanage.help.help_links["Tree/Cost Center"] = [
	{ label: "Budgeting", url: docsUrl + "user/manual/en/accounts/budgeting" },
];

//Stock

dontmanage.help.help_links["List/Item"] = [
...
dontmanage.help.help_links["Form/Item"] = [
	{ label: "Item", url: docsUrl + "user/manual/en/stock/item" },
	{
		label: "Item Price",
		url: docsUrl + "user/manual/en/stock/item-price",
...
dontmanage.help.help_links["List/Purchase Receipt"] = [
	{
...
dontmanage.help.help_links["List/Delivery Note"] = [
	{
		label: "Delivery Note",
...
dontmanage.help.help_links["Form/Delivery Note"] = [
	{
		label: "Delivery Note",
		url: docsUrl + "user/manual/en/stock/delivery-note",
	},
...
dontmanage.help.help_links["List/Installation Note"] = [
	{
...
dontmanage.help.help_links["List/Budget"] = [
	{ label: "Budgeting", url: docsUrl + "user/manual/en/accounts/budgeting" },
];

dontmanage.help.help_links["List/Material Request"] = [
	{
...
dontmanage.help.help_links["Form/Material Request"] = [
	{
		label: "Material Request",
		url: docsUrl + "user/manual/en/stock/material-request",
	},
...
dontmanage.help.help_links["Form/Stock Entry"] = [
...
dontmanage.help.help_links["List/Stock Entry"] = [
	{ label: "Stock Entry", url: docsUrl + "user/manual/en/stock/stock-entry" },
];

dontmanage.help.help_links["Tree/Warehouse"] = [
	{ label: "Warehouse", url: docsUrl + "user/manual/en/stock/warehouse" },
];

dontmanage.help.help_links["List/Serial No"] = [
	{ label: "Serial No", url: docsUrl + "user/manual/en/stock/serial-no" },
];

dontmanage.help.help_links["Form/Serial No"] = [
	{ label: "Serial No", url: docsUrl + "user/manual/en/stock/serial-no" },
];

dontmanage.help.help_links["List/Batch"] = [
	{ label: "Batch", url: docsUrl + "user/manual/en/stock/batch" },
];

dontmanage.help.help_links["Form/Batch"] = [
	{ label: "Batch", url: docsUrl + "user/manual/en/stock/batch" },
];

dontmanage.help.help_links["Form/Packing Slip"] = [
	{
		label: "Packing Slip",
...
dontmanage.help.help_links["Form/Quality Inspection"] = [
	{
...
dontmanage.help.help_links["Form/Landed Cost Voucher"] = [
	{
...
dontmanage.help.help_links["Tree/Item Group"] = [
	{
		label: "Item Group",
...
dontmanage.help.help_links["Form/Item Attribute"] = [
	{
...
dontmanage.help.help_links["Form/UOM"] = [
	{
...
dontmanage.help.help_links["Form/Stock Reconciliation"] = [
	{
...
dontmanage.help.help_links["Form/Sales Person"] = [
	{
...
dontmanage.help.help_links["Form/BOM"] = [
	{
...
dontmanage.help.help_links["Form/Work Order"] = [
	{
		label: "Work Order",
...
dontmanage.help.help_links["Form/Workstation"] = [
	{
		label: "Workstation",
...
dontmanage.help.help_links["Form/Operation"] = [
	{
		label: "Operation",
...
dontmanage.help.help_links["Form/BOM Update Tool"] = [
	{
...
dontmanage.help.help_links["Form/Customize Form"] = [
	{
		label: "Custom Field",
		url: docsUrl + "user/manual/en/customize-dontmanageerp/custom-field",
	},
	{
		label: "Customize Field",
		url: docsUrl + "user/manual/en/customize-dontmanageerp/customize-form",
	},
];

dontmanage.help.help_links["List/Custom Field"] = [
	{
		label: "Custom Field",
		url: docsUrl + "user/manual/en/customize-dontmanageerp/custom-field",
	},
...
dontmanage.help.help_links["Form/Custom Field"] = [
	{
		label: "Custom Field",
		url: docsUrl + "user/manual/en/customize-dontmanageerp/custom-field",
	},
