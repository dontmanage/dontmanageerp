...
dontmanage.help.help_links["Form/Document Naming Settings"] = [
	{
		label: "Naming Series",
...
dontmanage.help.help_links["List/Supplier"] = [{ label: "Supplier", url: docsUrl + "user/manual/en/supplier" }];

dontmanage.help.help_links["Form/Supplier"] = [{ label: "Supplier", url: docsUrl + "user/manual/en/supplier" }];
...
dontmanage.help.help_links["List/Workflow"] = [{ label: "Workflow", url: docsUrl + "user/manual/en/workflows" }];
...
dontmanage.help.help_links["List/Budget"] = [{ label: "Budgeting", url: docsUrl + "user/manual/en/budgeting" }];
...
dontmanage.help.help_links["List/Batch"] = [{ label: "Batch", url: docsUrl + "user/manual/en/batch" }];

dontmanage.help.help_links["Form/Batch"] = [{ label: "Batch", url: docsUrl + "user/manual/en/batch" }];
...
dontmanage.help.help_links["Form/Lead"] = [{ label: "Lead", url: docsUrl + "user/manual/en/lead" }];

dontmanage.help.help_links["Form/Opportunity"] = [
	{ label: "Opportunity", url: docsUrl + "user/manual/en/opportunity" },
];

dontmanage.help.help_links["Form/Address"] = [{ label: "Address", url: docsUrl + "user/manual/en/address" }];

dontmanage.help.help_links["Form/Contact"] = [{ label: "Contact", url: docsUrl + "user/manual/en/contact" }];

dontmanage.help.help_links["Form/Newsletter"] = [
	{ label: "Newsletter", url: docsUrl + "user/manual/en/newsletter" },
];

dontmanage.help.help_links["Form/Campaign"] = [{ label: "Campaign", url: docsUrl + "user/manual/en/campaign" }];
