...
dontmanage.ui.form.on('Asset Depreciation Schedule', {
	onload: function(frm) {
...
dontmanage.ui.form.on('Depreciation Schedule', {
	...
	depreciation_amount: function(frm, cdt, cdn) {
		dontmanageerp.asset.set_accumulated_depreciation(frm);
	}
});

dontmanageerp.asset.set_accumulated_depreciation = function(frm) {
