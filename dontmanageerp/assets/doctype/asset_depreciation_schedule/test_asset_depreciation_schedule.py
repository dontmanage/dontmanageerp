...
class TestAssetDepreciationSchedule(DontManageTestCase):
	...
	def test_schedule_for_slm_for_existing_asset_daily_pro_rata_enabled(self):
		dontmanage.db.set_single_value("Accounts Settings", "calculate_depr_using_total_days", 1)
		asset = create_asset(
			calculate_depreciation=1,
			depreciation_method="Straight Line",
		...
		self.assertEqual(schedules, expected_schedules)
		dontmanage.db.set_single_value("Accounts Settings", "calculate_depr_using_total_days", 0)
