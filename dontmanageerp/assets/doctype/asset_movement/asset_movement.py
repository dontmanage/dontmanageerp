...
class AssetMovement(Document):
	...
	if TYPE_CHECKING:
		...
		from dontmanageerp.assets.doctype.asset_movement_item.asset_movement_item import AssetMovementItem
	...
	def set_latest_location_and_custodian_in_asset(self):
		...
		for d in self.assets:
			...
			dontmanage.db.set_value("Asset", d.asset, "location", current_location, update_modified=False)
			dontmanage.db.set_value("Asset", d.asset, "custodian", current_employee, update_modified=False)
