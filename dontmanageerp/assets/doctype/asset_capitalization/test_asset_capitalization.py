...
import dontmanage
from dontmanage.utils import cint, flt, getdate, now_datetime
...
class TestAssetCapitalization(unittest.TestCase):
	...
	def test_capitalization_with_perpetual_inventory(self):
		...
		target_asset = dontmanage.get_doc("Asset", asset_capitalization.target_asset)
	...
	def test_capitalization_with_periodical_inventory(self):
		...
		# Test General Ledger Entries
		default_expense_account = dontmanage.db.get_value("Company", company, "default_expense_account")
		expected_gle = {
...
def create_asset_capitalization(**args):
	...
	now = now_datetime()
	target_asset = dontmanage.get_doc("Asset", args.target_asset) if args.target_asset else dontmanage._dict()
				...
				dontmanage._dict(
					{
						...
						"company": dontmanage.get_cached_value("Warehouse", source_warehouse, "company"),
...
def create_depreciation_asset(**args):
	...
	asset = dontmanage.new_doc("Asset")
