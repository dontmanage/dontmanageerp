...
from dontmanageerp.assets.doctype.asset.test_asset import create_asset
from dontmanageerp.assets.doctype.asset_depreciation_schedule.asset_depreciation_schedule import (
	get_depr_schedule,
)


class TestAssetShiftAllocation(DontManageTestCase):
	@classmethod
	def setUpClass(cls):
	...
	def test_asset_shift_allocation(self):
		...
		asset_shift_allocation = dontmanage.get_doc(
		...
		asset_shift_allocation = dontmanage.get_doc("Asset Shift Allocation", asset_shift_allocation.name)
