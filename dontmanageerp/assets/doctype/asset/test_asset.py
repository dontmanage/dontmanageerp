...
class TestDepreciationBasics(AssetSetup):
	...
	def test_get_depreciation_amount(self):
		...
		from dontmanageerp.assets.doctype.asset.asset import get_depreciation_amount
	...
	def test_depr_entry_posting_when_depr_expense_account_is_an_expense_account(self):
		...
		je = dontmanage.get_doc("Journal Entry", asset.schedules[0].journal_entry)
		accounting_entries = [
