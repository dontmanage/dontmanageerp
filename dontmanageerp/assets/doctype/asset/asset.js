	...
	refresh: function (frm) {
		...
		if (frm.doc.docstatus == 0) {
			...
			if (frm.doc.is_composite_asset) {
				dontmanage.call({
					method: "dontmanageerp.assets.doctype.asset.asset.has_active_capitalization",
					args: {
						asset: frm.doc.name,
					},
					callback: function (r) {
...
dontmanage.ui.form.on("Asset Finance Book", {
	...
	depreciation_start_date: function (frm, cdt, cdn) {
		...
		if (frm.doc.available_for_use_date && book.depreciation_start_date < frm.doc.available_for_use_date) {
			dontmanage.msgprint(__("Depreciation Posting Date cannot be before Available-for-use Date"));
