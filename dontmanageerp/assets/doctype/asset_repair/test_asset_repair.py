...
class TestAssetRepair(unittest.TestCase):
	...
	def test_gl_entries_with_perpetual_inventory(self):
		...
		stock_entry_expense_account = (
			dontmanage.get_doc("Stock Entry", asset_repair.stock_entry).get("items")[0].expense_account
		)
				...
				dontmanage._dict(
					{
						...
						"company": dontmanage.get_cached_value("Warehouse", asset_repair.warehouse, "company"),
