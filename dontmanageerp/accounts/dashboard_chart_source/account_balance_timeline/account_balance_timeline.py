...
from dontmanage.utils import add_to_date, formatdate, get_link_to_form, getdate, nowdate
from dontmanage.utils.dashboard import cache_source
from dontmanage.utils.dateutils import get_from_date_from_timespan, get_period_ending
...
def get(
	...
	if not dontmanage.db.exists("Account", account) and chart_name:
		dontmanage.throw(
...
def build_result(account, dates, gl_entries):
	...
	root_type = dontmanage.get_cached_value("Account", account, "root_type")
