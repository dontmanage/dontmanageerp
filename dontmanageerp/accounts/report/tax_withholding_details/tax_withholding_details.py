	...
	for name, details in gle_map.items():
		for entry in details:
			...
			if tax_amount:
				...
				row = {
					"pan"
					if dontmanage.db.has_column(filters.party_type, "pan")
...
def get_tds_docs_query(filters, bank_accounts, tds_accounts):
	if not tds_accounts:
		dontmanage.throw(
			_("No {0} Accounts found for this company.").format(dontmanage.bold("Tax Withholding")),
