...
def execute(filters=None):
	...
	account_currency = dontmanage.get_cached_value("Account", filters.account, "account_currency")
...
def get_entries(filters):
	...
	for method_name in dontmanage.get_hooks("get_entries_for_bank_reconciliation_statement"):
		entries += dontmanage.get_attr(method_name)(filters) or []
