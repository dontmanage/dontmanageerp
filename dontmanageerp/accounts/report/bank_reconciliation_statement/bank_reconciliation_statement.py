...
def execute(filters=None):
	...
	account_currency = dontmanage.db.get_value("Account", filters.account, "account_currency")
...
def get_loan_entries(filters):
	...
	for doctype in ["Loan Disbursement", "Loan Repayment"]:
		loan_doc = dontmanage.qb.DocType(doctype)
		...
		if doctype == "Loan Repayment" and dontmanage.db.has_column("Loan Repayment", "repay_from_salary"):
