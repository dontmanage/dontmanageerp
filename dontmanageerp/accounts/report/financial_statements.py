...
def set_gl_entries_by_account(
	...
	accounts = dontmanage.db.sql_list(
	...
	if accounts:
		additional_conditions += " and account in ({})".format(
			", ".join(dontmanage.db.escape(d) for d in accounts)
		)
		...
		if filters.get("include_default_book_entries"):
			gl_filters["company_fb"] = dontmanage.db.get_value("Company", company, "default_finance_book")
