...
from dontmanageerp.accounts.report.tds_payable_monthly.tds_payable_monthly import (
	get_result,
	get_tds_docs,
)
...
def execute(filters=None):
	...
	filters.naming_series = dontmanage.db.get_single_value("Buying Settings", "supp_master_name")
