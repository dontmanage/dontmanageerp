...
from dontmanageerp.accounts.report.tax_withholding_details.tax_withholding_details import (
	get_result,
	get_tds_docs,
)
...
def validate_filters(filters):
	...
	if from_year != to_year:
		dontmanage.throw(_("From Date and To Date lie in different Fiscal Year"))
