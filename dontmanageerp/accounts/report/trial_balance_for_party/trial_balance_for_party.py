...
def get_data(filters, show_party_name):
	if filters.get("party_type") in ("Customer", "Supplier", "Employee", "Member"):
		party_name_field = "{0}_name".format(dontmanage.scrub(filters.get("party_type")))
...
def get_opening_balances(filters):
	...
	if filters.get("account"):
		account_filter = "and account = %s" % (dontmanage.db.escape(filters.get("account")))
...
def get_balances_within_period(filters):
	...
	balances_within_period = dontmanage._dict()
	for d in gle:
