...
dontmanage.query_reports["Accounts Receivable Summary"] = {
	filters: [
		{
			fieldname: "company",
			label: __("Company"),
		...
		},
		{
			...
			on_change: function () {
				...
				dontmanage.query_report.toggle_filter_display(
					"customer_group",
					dontmanage.query_report.get_filter_value("party_type") !== "Customer"
				);
			},
		},
		{
	...
	onload: function (report) {
		report.page.add_inner_button(__("Accounts Receivable"), function () {
			...
			dontmanage.set_route("query-report", "Accounts Receivable", { company: filters.company });
		});
	},
};
