...
from dontmanageerp.accounts.report.accounts_receivable_summary.accounts_receivable_summary import execute
...
class TestAccountsReceivable(AccountsTestMixin, DontManageTestCase):
	...
	def test_01_receivable_summary_output(self):
		...
		customer_group, customer_territory = dontmanage.db.get_all(
			"Customer",
