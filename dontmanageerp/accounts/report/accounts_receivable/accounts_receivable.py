...
from dontmanage.query_builder.functions import Date
...
from dontmanageerp.accounts.utils import get_currency_precision
...
class ReceivablePayableReport(object):
	...
	def get_return_entries(self):
		...
		self.return_entries = dontmanage._dict(
			dontmanage.get_all(doctype, filters, ["name", "return_against"], as_list=1)
		)
