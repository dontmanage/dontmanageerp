...
from dontmanageerp.accounts.report.balance_sheet.balance_sheet import execute


class TestBalanceSheet(DontManageTestCase):
	def test_balance_sheet(self):
		...
		dontmanage.db.sql("delete from `tabSales Invoice` where company='_Test Company 6'")
