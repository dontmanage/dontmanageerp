...
def execute(filters=None):
	...
	currency = filters.presentation_currency or dontmanage.get_cached_value(
...
def get_provisional_profit_loss(
	...
	if asset and (liability or equity):
		...
		currency = currency or dontmanage.get_cached_value("Company", company, "default_currency")
		total_row = {
