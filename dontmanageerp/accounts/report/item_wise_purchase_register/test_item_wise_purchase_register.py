...
from dontmanageerp.accounts.report.item_wise_purchase_register.item_wise_purchase_register import execute
from dontmanageerp.accounts.test.accounts_mixin import AccountsTestMixin


class TestItemWisePurchaseRegister(AccountsTestMixin, DontManageTestCase):
	def setUp(self):
		self.create_company()
