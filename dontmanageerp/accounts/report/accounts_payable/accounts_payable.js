...
dontmanage.query_reports["Accounts Payable"] = {
	filters: [
		{
			fieldname: "company",
			label: __("Company"),
		...
		},
		{
			...
			on_change: function () {
				...
				dontmanage.query_report.toggle_filter_display(
					"supplier_group",
					dontmanage.query_report.get_filter_value("party_type") !== "Supplier"
				);
			},
		},
		{
	...
	onload: function (report) {
		report.page.add_inner_button(__("Accounts Payable Summary"), function () {
			...
			dontmanage.set_route("query-report", "Accounts Payable Summary", { company: filters.company });
		});
	},
};
