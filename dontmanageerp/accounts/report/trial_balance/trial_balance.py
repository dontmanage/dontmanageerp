...
from dontmanage.utils import cstr, flt, formatdate, getdate
...
def validate_filters(filters):
	...
	fiscal_year = dontmanage.db.get_value(
...
def get_rootwise_opening_balances(filters, report_type):
	...
	query_filters = {
		...
		"company_fb": dontmanage.db.get_value("Company", filters.company, "default_finance_book"),
	}
