...
class TestUtils(unittest.TestCase):
	...
	def test_update_reference_in_payment_entry(self):
		...
		payment_reconciliation = dontmanage.new_doc("Payment Reconciliation")
	...
	def test_naming_series_variable_parsing(self):
		...
		dontmanage.db.set_default("supp_master_name", "Auto Name")
		...
		dontmanage.db.set_default("supp_master_name", "Supplier Name")
