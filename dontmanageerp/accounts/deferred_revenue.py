...
def book_deferred_income_or_expense(doc, deferred_process, posting_date=None):
	...
	accounts_frozen_upto = dontmanage.get_cached_value("Accounts Settings", "None", "acc_frozen_upto")
	...
	submit_journal_entry = cint(
		dontmanage.db.get_singles_value("Accounts Settings", "submit_journal_entries")
	)
...
def process_deferred_accounting(posting_date=None):
	...
	if not cint(
		dontmanage.db.get_singles_value(
