...
from dontmanage.utils import add_days, flt, format_date, getdate
...
class CostCenterAllocation(Document):
	...
	if TYPE_CHECKING:
		...
		from dontmanageerp.accounts.doctype.cost_center_allocation_percentage.cost_center_allocation_percentage import (
	...
	def validate_total_allocation_percentage(self):
		...
		if total_percentage != 100:
			dontmanage.throw(_("Total percentage against cost centers should be 100"), WrongPercentageAllocation)
