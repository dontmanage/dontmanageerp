...
dontmanageerp.accounts.PaymentReconciliationController = class PaymentReconciliationController extends (
	dontmanage.ui.form.Controller
) {
	onload() {
				...
				callback: (r) => {
					if (r.message) {
						this.frm
							...
							.then((r) => {
								if (r.message) {
									let doc_link = dontmanage.utils.get_form_link(
