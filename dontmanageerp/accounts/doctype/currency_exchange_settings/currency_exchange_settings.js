...
dontmanage.ui.form.on("Currency Exchange Settings", {
	service_provider: function (frm) {
		frm.call({
			method: "dontmanageerp.accounts.doctype.currency_exchange_settings.currency_exchange_settings.get_api_endpoint",
			args: {
