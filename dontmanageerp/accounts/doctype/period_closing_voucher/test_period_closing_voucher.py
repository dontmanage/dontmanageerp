...
from dontmanageerp.accounts.doctype.finance_book.test_finance_book import create_finance_book
...
class TestPeriodClosingVoucher(unittest.TestCase):
	def test_closing_entry(self):
		dontmanage.db.sql("delete from `tabGL Entry` where company='Test PCV Company'")
		dontmanage.db.sql("delete from `tabPeriod Closing Voucher` where company='Test PCV Company'")
	...
	def test_gl_entries_restrictions(self):
		...
		self.assertRaises(dontmanage.ValidationError, jv1.submit)

	def test_closing_balance_with_dimensions_and_test_reposting_entry(self):
		dontmanage.db.sql("delete from `tabGL Entry` where company='Test PCV Company'")
		dontmanage.db.sql("delete from `tabPeriod Closing Voucher` where company='Test PCV Company'")
		dontmanage.db.sql("delete from `tabAccount Closing Balance` where company='Test PCV Company'")
		...
		closing_balance = dontmanage.db.get_value(
		...
		cc1_closing_balance = dontmanage.db.get_value(
			"Account Closing Balance",
			{
				"account": "Sales - TPC",
				"cost_center": cost_center1,
		...
		cc2_closing_balance = dontmanage.db.get_value(
			"Account Closing Balance",
			{
				"account": "Sales - TPC",
				"cost_center": cost_center2,
		...
		warehouse = dontmanage.db.get_value("Warehouse", {"company": company}, "name")
		...
		self.assertRaises(dontmanage.ValidationError, repost_doc.save)
...
test_records = dontmanage.get_test_records("Period Closing Voucher")
