...
class PeriodClosingVoucher(AccountsController):
	...
	def validate_account_head(self):
		closing_account_type = dontmanage.db.get_value("Account", self.closing_account_head, "root_type")
	...
	def validate_posting_date(self):
		from dontmanageerp.accounts.utils import get_fiscal_year, validate_fiscal_year
	...
	def make_gl_entries(self):
		...
		if gl_entries:
			if len(gl_entries) > 5000:
				dontmanage.enqueue(process_gl_entries, gl_entries=gl_entries, queue="long")
				dontmanage.msgprint(
