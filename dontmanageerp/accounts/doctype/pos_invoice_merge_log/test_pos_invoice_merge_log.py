...
from dontmanageerp.accounts.doctype.pos_closing_entry.test_pos_closing_entry import init_user_and_profile
...
class TestPOSInvoiceMergeLog(unittest.TestCase):
	def test_consolidated_invoice_creation(self):
		...
		try:
			...
			self.assertTrue(dontmanage.db.exists("Sales Invoice", pos_inv.consolidated_invoice))

			pos_inv3.load_from_db()
			self.assertTrue(dontmanage.db.exists("Sales Invoice", pos_inv3.consolidated_invoice))
	...
	def test_consolidated_credit_note_creation(self):
		...
		try:
			...
			self.assertTrue(dontmanage.db.exists("Sales Invoice", pos_inv_cn.consolidated_invoice))
			consolidated_credit_note = dontmanage.get_doc("Sales Invoice", pos_inv_cn.consolidated_invoice)
	...
	def test_consolidated_invoice_item_taxes(self):
		...
		try:
			...
			consolidated_invoice = dontmanage.get_doc("Sales Invoice", inv.consolidated_invoice)
