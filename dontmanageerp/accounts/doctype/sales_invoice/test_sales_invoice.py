...
from dontmanageerp.stock.doctype.serial_no.serial_no import SerialNoWarehouseError
...
class TestSalesInvoice(unittest.TestCase):
	...
	def test_pos_with_no_gl_entry_for_change_amount(self):
		dontmanage.db.set_value("Accounts Settings", None, "post_change_gl_entries", 0)
		...
		dontmanage.db.set_value("Accounts Settings", None, "post_change_gl_entries", 1)
	...
	def test_serialized(self):
		...
		self.assertEqual(
			dontmanage.db.get_value("Serial No", serial_nos[0], "delivery_document_no"), si.name
		)
	...
	def test_serialized_cancel(self):
		...
		self.assertFalse(dontmanage.db.get_value("Serial No", serial_nos[0], "delivery_document_no"))
		self.assertFalse(dontmanage.db.get_value("Serial No", serial_nos[0], "sales_invoice"))

	def test_serialize_status(self):
		serial_no = dontmanage.get_doc(
			{
				"doctype": "Serial No",
	...
	def test_return_sales_invoice(self):
		...
		self.assertEqual(dontmanage.db.get_value("Sales Invoice", si.name, "outstanding_amount"), 1500)
	...
	def test_outstanding_amount_after_advance_payment_entry_cancellation(self):
		...
		# added to avoid Document has been modified exception
		pe = dontmanage.get_doc("Payment Entry", pe.name)
		pe.cancel()
	...
	def test_inter_company_transaction_without_default_warehouse(self):
		...
		dontmanage.db.set_value("Stock Settings", None, "allow_negative_stock", old_negative_stock)
	...
	def test_sales_invoice_against_supplier(self):
		...
		dontmanage.db.set_value("Accounts Settings", None, "enable_common_party_accounting", 1)
		...
		party_link.delete()
		dontmanage.db.set_value("Accounts Settings", None, "enable_common_party_accounting", 0)
	...
	def test_sales_invoice_submission_post_account_freezing_date(self):
		dontmanage.db.set_value("Accounts Settings", None, "acc_frozen_upto", add_days(getdate(), 1))
		si = create_sales_invoice(do_not_save=True)
	...
	def test_over_billing_case_against_delivery_note(self):
		...
		dontmanage.db.set_value("Accounts Settings", None, "over_billing_allowance", over_billing_allowance)
	...
	def test_multi_currency_deferred_revenue_via_journal_entry(self):
		...
		acc_settings = dontmanage.get_single("Accounts Settings")
		...
		dontmanage.db.set_value("Accounts Settings", None, "acc_frozen_upto", getdate("2019-01-31"))
