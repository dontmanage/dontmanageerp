...
def create_finance_book():
	if not dontmanage.db.exists("Finance Book", "_Test Finance Book"):
		finance_book = dontmanage.get_doc(
			{"doctype": "Finance Book", "finance_book_name": "_Test Finance Book"}
		).insert()
	else:
		finance_book = dontmanage.get_doc("Finance Book", "_Test Finance Book")
