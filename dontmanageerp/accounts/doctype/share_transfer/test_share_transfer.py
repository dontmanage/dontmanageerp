...
from dontmanageerp.accounts.doctype.share_transfer.share_transfer import ShareDontExists
...
class TestShareTransfer(unittest.TestCase):
	def setUp(self):
		dontmanage.db.sql("delete from `tabShare Transfer`")
		dontmanage.db.sql("delete from `tabShare Balance`")
		share_transfers = [
			{
