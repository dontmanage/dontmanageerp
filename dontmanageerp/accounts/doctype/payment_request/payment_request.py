	...
	def get_payment_url(self):
		...
		return controller.get_payment_url(
			**{
				...
				"payer_name": dontmanage.safe_encode(data.customer_name),
				"order_id": self.name,
				"currency": self.currency,
			}
		)
...
def get_existing_payment_request_amount(ref_dt, ref_dn):
	...
	"""
	existing_payment_request_amount = dontmanage.db.sql(
		"""
...
def update_payment_req_status(doc, method):
	from dontmanageerp.accounts.doctype.payment_entry.payment_entry import get_reference_details

	for ref in doc.references:
		payment_request_name = dontmanage.db.get_value(
			"Payment Request",
			{
		...
		if payment_request_name:
			...
			pay_req_doc = dontmanage.get_doc("Payment Request", payment_request_name)
