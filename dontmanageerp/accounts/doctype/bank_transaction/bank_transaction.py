...
class BankTransaction(Document):
	...
	def validate_currency(self):
		...
		if self.currency and self.bank_account:
			account = dontmanage.get_cached_value("Bank Account", self.bank_account, "account")
			...
			if self.currency != account_currency:
				dontmanage.throw(
					_(
						...
						dontmanage.bold(self.currency), dontmanage.bold(self.bank_account), dontmanage.bold(account_currency)
					)
				)
