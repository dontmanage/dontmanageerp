...
def create_plan():
	if not dontmanage.db.exists("Subscription Plan", "_Test Plan Name"):
	...
	if not dontmanage.db.exists("Subscription Plan", "_Test Plan Name 2"):
		plan = dontmanage.new_doc("Subscription Plan")
	...
	if not dontmanage.db.exists("Subscription Plan", "_Test Plan Name 3"):
		plan = dontmanage.new_doc("Subscription Plan")
	...
	if not dontmanage.db.exists("Subscription Plan", "_Test Plan Name 4"):
		plan = dontmanage.new_doc("Subscription Plan")
	...
	if not dontmanage.db.exists("Subscription Plan", "_Test Plan Multicurrency"):
		plan = dontmanage.new_doc("Subscription Plan")
...
class TestSubscription(unittest.TestCase):
	...
	def test_multicurrency_subscription(self):
		...
		currency = dontmanage.db.get_value("Sales Invoice", subscription.invoices[0].invoice, "currency")
