...
from dontmanageerp.tests.utils import if_lending_app_installed, if_lending_app_not_installed
...
class TestBankClearance(unittest.TestCase):
	...
	def test_bank_clearance(self):
		bank_clearance = dontmanage.get_doc("Bank Clearance")
	...
	def test_update_clearance_date_on_si(self):
		...
		si_clearance_date = dontmanage.db.get_value(
...
def clear_payment_entries():
	dontmanage.db.delete("Payment Entry")


def clear_pos_sales_invoices():
	dontmanage.db.delete("Sales Invoice", {"is_pos": 1})
...
def make_bank_account():
	if not dontmanage.db.get_value("Account", "_Test Bank Clearance - _TC"):
		dontmanage.get_doc(
			{
				"doctype": "Account",
				"account_type": "Bank",
