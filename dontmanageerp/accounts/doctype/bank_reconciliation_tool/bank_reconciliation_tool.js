...
dontmanage.ui.form.on("Bank Reconciliation Tool", {
	...
	refresh: function (frm) {
		frm.disable_save();
		dontmanage.require("bank-reconciliation-tool.bundle.js", () =>
		...
		frm.add_custom_button(__("Upload Bank Statement"), () =>
				dontmanage.call({
					method:
						"dontmanageerp.accounts.doctype.bank_statement_import.bank_statement_import.upload_bank_statement",
					args: {
						dt: frm.doc.doctype,
						dn: frm.doc.name,
						company: frm.doc.company,
	...
	render(frm) {
		if (frm.doc.bank_account) {
			frm.bank_reconciliation_data_table_manager = new dontmanageerp.accounts.bank_reconciliation.DataTableManager(
				{
					company: frm.doc.company,
					bank_account: frm.doc.bank_account,
