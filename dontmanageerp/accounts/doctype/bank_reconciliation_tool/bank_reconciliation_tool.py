...
def check_matching(
	...
	for query in queries:
		matching_vouchers.extend(dontmanage.db.sql(query, filters, as_dict=True))
...
def get_bt_matching_query(exact_match, transaction):
	...
	ref_rank = (
		dontmanage.qb.terms.Case().when(bt.reference_number == transaction.reference_number, 1).else_(0)
	)
	unallocated_rank = (
...
def get_pe_matching_query(
	...
	if dontmanage.flags.auto_reconcile_vouchers == True:
