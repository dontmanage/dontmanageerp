...
class Account(NestedSet):
	...
	def validate(self):
		from dontmanageerp.accounts.utils import validate_field_number
	...
	def validate_root_company_and_sync_account_to_children(self):
		...
		if (
			dontmanage.local.flags.ignore_root_company_validation or self.flags.ignore_root_company_validation
		):
			return
