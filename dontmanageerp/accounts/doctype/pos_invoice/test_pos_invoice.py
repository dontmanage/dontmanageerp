...
class TestPOSInvoice(unittest.TestCase):
	...
	def tearDown(self):
		...
		if dontmanage.db.get_single_value("Selling Settings", "validate_selling_price"):
			dontmanage.db.set_single_value("Selling Settings", "validate_selling_price", 0)
	...
	def test_invalid_serial_no_validation(self):
		...
		self.assertRaises(dontmanage.ValidationError, pos.insert)
	...
	def test_loyalty_points(self):
		...
		create_records()
		dontmanage.db.set_value("Customer", "Test Loyalty Customer", "loyalty_program", "Test Single Loyalty")
	...
	def test_merging_into_sales_invoice_with_discount(self):
		...
		rounded_total = dontmanage.db.get_value("Sales Invoice", pos_inv.consolidated_invoice, "rounded_total")
	...
	def test_merging_with_validate_selling_price(self):
		...
		if not dontmanage.db.get_single_value("Selling Settings", "validate_selling_price"):
			dontmanage.db.set_single_value("Selling Settings", "validate_selling_price", 1)
		...
		rounded_total = dontmanage.db.get_value("Sales Invoice", pos_inv2.consolidated_invoice, "rounded_total")
	...
	def test_pos_batch_reservation(self):
		...
		batches = get_auto_batch_nos(
			dontmanage._dict({"item_code": "_BATCH ITEM Test For Reserve", "warehouse": "_Test Warehouse - _TC"})
		)
		...
		sn_doc = SerialBatchCreation(
			{
				...
				"qty": 2,
				"avg_rate": 300,
				"batches": dontmanage._dict({"TestBatch 01": 2}),
