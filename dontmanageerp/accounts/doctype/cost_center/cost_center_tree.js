dontmanage.treeview_settings["Cost Center"] = {
	breadcrumb: "Accounts",
	get_tree_root: false,
	filters: [{
		fieldname: "company",
	...
	add_tree_node: 'dontmanageerp.accounts.utils.add_cc',
	menu_items:[
		{
	...
	onload: function(treeview) {
		...
		treeview.page.add_inner_button(__("Chart of Accounts"), function() {
			dontmanage.set_route('Tree', 'Account', {company: get_company()});
		}, __('View'));

		// make
		treeview.page.add_inner_button(__("Budget List"), function() {
			dontmanage.set_route('List', 'Budget', {company: get_company()});
		}, __('Budget'));

		treeview.page.add_inner_button(__("Monthly Distribution"), function() {
			dontmanage.set_route('List', 'Monthly Distribution', {company: get_company()});
		}, __('Budget'));

		treeview.page.add_inner_button(__("Budget Variance Report"), function() {
			dontmanage.set_route('query-report', 'Budget Variance Report', {company: get_company()});
		}, __('Budget'));
