...
dontmanage.ui.form.on('Bank Guarantee', {
	setup: function(frm) {
	...
	reference_docname: function(frm) {
		if (frm.doc.reference_docname && frm.doc.reference_doctype) {
			...
			dontmanage.call({
				method: "dontmanageerp.accounts.doctype.bank_guarantee.bank_guarantee.get_voucher_details",
				args: {
	...
	start_date: function(frm) {
		var end_date = dontmanage.datetime.add_days(cur_frm.doc.start_date, cur_frm.doc.validity - 1);
