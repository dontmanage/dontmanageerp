...
class BankAccount(Document):
	...
	def validate_account(self):
		if self.account:
			if accounts := dontmanage.db.get_all(
	...
	def validate_company(self):
		if self.is_company_account and not self.company:
			dontmanage.throw(_("Company is manadatory for company account"))
	...
	def validate_iban(self):
		...
		try:
			...
			dontmanage.throw(_("IBAN is not valid"))
...
def make_bank_account(doctype, docname):
	doc = dontmanage.new_doc("Bank Account")
...
def get_default_company_bank_account(company, party_type, party):
	default_company_bank_account = dontmanage.db.get_value(party_type, party, "default_bank_account")
	if default_company_bank_account:
		if company != dontmanage.get_cached_value("Bank Account", default_company_bank_account, "company"):
			default_company_bank_account = None

	if not default_company_bank_account:
		default_company_bank_account = dontmanage.db.get_value(
