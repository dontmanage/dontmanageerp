...
def make_closing_entries(closing_entries, voucher_name, company, closing_date):
	...
	for key, value in merged_entries.items():
		cle = dontmanage.new_doc("Account Closing Balance")
		cle.update(value)
...
def get_previous_closing_entries(company, closing_date, accounting_dimensions):
	...
	if last_period_closing_voucher:
		account_closing_balance = dontmanage.qb.DocType("Account Closing Balance")
		query = dontmanage.qb.from_(account_closing_balance).select(
