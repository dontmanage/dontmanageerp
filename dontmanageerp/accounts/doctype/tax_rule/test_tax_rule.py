...
from dontmanageerp.accounts.doctype.tax_rule.tax_rule import ConflictingTaxRule, get_tax_template
...
test_records = dontmanage.get_test_records("Tax Rule")


class TestTaxRule(unittest.TestCase):
	@classmethod
	def setUpClass(cls):
		dontmanage.db.set_single_value("Shopping Cart Settings", "enabled", 0)
...
def make_tax_rule(**args):
	...
	tax_rule = dontmanage.new_doc("Tax Rule")
