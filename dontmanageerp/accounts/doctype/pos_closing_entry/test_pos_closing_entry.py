...
class TestPOSClosingEntry(unittest.TestCase):
	...
	def test_merging_into_sales_invoice_for_batched_item(self):
		dontmanage.flags.print_message = False
		...
		batch_qty = dontmanage.db.get_value("Batch", batch_no, "batch_qty")
		...
		piv_merge = dontmanage.db.get_value("POS Invoice Merge Log", {"pos_closing_entry": pcv_doc.name}, "name")

		self.assertTrue(piv_merge)
		piv_merge_doc = dontmanage.get_doc("POS Invoice Merge Log", piv_merge)
		...
		dontmanage.flags.print_message = True
