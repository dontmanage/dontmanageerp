...
from dontmanageerp.manufacturing.doctype.routing.test_routing import create_routing, setup_bom
from dontmanageerp.manufacturing.doctype.workstation.workstation import (
...
test_records = dontmanage.get_test_records("Workstation")
make_test_records("Workstation")


class TestWorkstation(DontManageTestCase):
	...
	def test_update_bom_operation_rate(self):
		...
		w1 = dontmanage.get_doc("Workstation", "_Test Workstation A")
		# resets values
...
def make_workstation(*args, **kwargs):
	...
	if not dontmanage.db.exists("Workstation", workstation_name):
		doc = dontmanage.get_doc({"doctype": "Workstation", "workstation_name": workstation_name})
	...
	return dontmanage.get_doc("Workstation", workstation_name)
