...
from dontmanageerp.manufacturing.doctype.bom_creator.bom_creator import (
	add_item,
	add_sub_assembly,
	delete_node,
	edit_qty,
...
class TestBOMCreator(DontManageTestCase):
	def setUp(self) -> None:
		create_items()
	...
	def test_make_boms_from_bom_creator(self):
		...
		data = dontmanage.get_all("BOM", filters={"bom_creator": doc.name, "docstatus": 1})
...
def make_bom_creator(**kwargs):
	...
	doc = dontmanage.new_doc("BOM Creator")
	doc.update(kwargs)
	doc.save()
