...
dontmanage.query_reports["Production Planning Report"] = {
	"filters": [
		{
			"fieldname":"company",
			"label": __("Company"),
		...
		},
		{
			...
			"reqd": 1,
			on_change: function() {
				let filters = dontmanage.query_report.filters;
				let based_on = dontmanage.query_report.get_filter_value('based_on');
				let options = {
		...
		},
		{
			...
			"get_data": function(txt) {
				...
				return dontmanage.db.get_link_options(based_on, txt);
			},
			"get_query": function() {
