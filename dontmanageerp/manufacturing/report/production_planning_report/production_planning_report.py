...
class ProductionPlanReport(object):
	...
	def get_raw_materials(self):
		...
		if self.filters.based_on == "Work Order":
			...
			for d in self.orders:
				bom_no = d.bom_no or dontmanage.get_cached_value("Item", d.production_item, "default_bom")
			...
			bom_item = dontmanage.qb.DocType(bom_item_doctype)
	...
	def get_purchase_details(self):
		...
		purchased_items = dontmanage.get_all(
			"Purchase Order Item",
