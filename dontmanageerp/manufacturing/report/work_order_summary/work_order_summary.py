...
from dontmanage.utils import date_diff, flt, getdate, today

from dontmanageerp.stock.report.stock_analytics.stock_analytics import get_period, get_period_date_ranges
...
def get_chart_based_on_status(data):
	labels = dontmanage.get_meta("Work Order").get_options("status").split("\n")
	if "" in labels:
		labels.remove("")
