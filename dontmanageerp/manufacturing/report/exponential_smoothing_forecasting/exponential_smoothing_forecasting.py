...
from dontmanage.utils import add_years, cint, flt, getdate
...
class ForecastingReport(ExponentialSmoothingForecast):
	def __init__(self, filters=None):
		...
		self.company_currency = dontmanageerp.get_company_currency(self.filters.company)
	...
	def add_total(self):
		...
		total_row = {"item_code": _(dontmanage.bold("Total Quantity"))}
