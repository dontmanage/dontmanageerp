...
def get_production_plan_item_details(filters, data, order_details):
	...
	production_plan_doc = dontmanage.get_cached_doc("Production Plan", filters.get("production_plan"))
	for row in production_plan_doc.po_items:
		work_order = dontmanage.get_value(
			"Work Order",
		...
		data.append(
			{
				...
				"item_name": dontmanage.get_cached_value("Item", row.item_code, "item_name"),
				"qty": row.planned_qty,
