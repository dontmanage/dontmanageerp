...
def get_context(context):
	...
	setting = dontmanage.get_doc("Support Settings")
...
def get_favorite_articles(favorite_articles):
	...
	for article in favorite_articles:
		description = dontmanage.utils.strip_html(article.content)
...
def get_help_article_list():
	help_article_list = []
	category_list = dontmanage.get_all("Help Category", fields="name")
	for category in category_list:
		help_articles = dontmanage.get_all(
			"Help Article",
			fields="*",
