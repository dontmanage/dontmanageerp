...
from dontmanage.utils.global_search import search
...
def get_context(context):
	...
	if dontmanage.form_dict.q:
		query = str(utils.escape(sanitize_html(dontmanage.form_dict.q)))
...
def get_help_results_sections(text):
	out = []
	settings = dontmanage.get_doc("Support Settings", "Support Settings")
