...
$.extend(shopping_cart, {
	...
	get_update_address_dialog() {
		let d = new dontmanage.ui.Dialog({
			...
			primary_action: () => {
				...
				dontmanage.call({
					type: "POST",
					method: "dontmanageerp.e_commerce.shopping_cart.cart.update_cart_address",
					freeze: true,
					args: {
						address_type,
						address_name
	...
	apply_shipping_rule: function(rule, btn) {
		return dontmanage.call({
			btn: btn,
			type: "POST",
			method: "dontmanageerp.e_commerce.shopping_cart.cart.apply_shipping_rule",
	...
	place_order: function(btn) {
		...
		return dontmanage.call({
			type: "POST",
			method: "dontmanageerp.e_commerce.shopping_cart.cart.place_order",
			btn: btn,
			callback: function(r) {
				if(r.exc) {
					...
					$("#cart-error")
						.empty()
						.html(msg || dontmanage._("Something went wrong!"))
						.toggle(true);
				} else {
					$(btn).hide();
	...
	request_quotation: function(btn) {
		...
		return dontmanage.call({
			type: "POST",
			method: "dontmanageerp.e_commerce.shopping_cart.cart.request_for_quotation",
			btn: btn,
			callback: function(r) {
				if(r.exc) {
					shopping_cart.unfreeze();
	...
	apply_coupon_code: function(btn) {
		return dontmanage.call({
			type: "POST",
			method: "dontmanageerp.e_commerce.shopping_cart.cart.apply_coupon_code",
			btn: btn,
			args : {
