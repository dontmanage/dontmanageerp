...
def create_email_digest():
	...
	companies = dontmanage.db.sql_list("select name FROM `tabCompany`")
	for company in companies:
		if not dontmanage.db.exists("Email Digest", "Default Weekly Digest - " + company):
			edigest = dontmanage.get_doc(
				{
	...
	if companies:
		edigest = dontmanage.new_doc("Email Digest")
		edigest.update(
			{
