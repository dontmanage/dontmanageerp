...
def get_company_for_dashboards():
	...
	if company:
		...
		company_list = dontmanage.get_list("Company")
		if company_list:
...
def get_default_dashboards():
	company = dontmanage.get_doc("Company", get_company_for_dashboards())
...
def get_account(account_type, company):
	accounts = dontmanage.get_list("Account", filters={"account_type": account_type, "company": company})
	if accounts:
