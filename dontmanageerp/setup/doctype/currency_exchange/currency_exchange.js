...
extend_cscript(cur_frm.cscript, {
	onload: function() {
		if(cur_frm.doc.__islocal) {
			cur_frm.set_value("to_currency", dontmanage.defaults.get_global_default("currency"));
		}
	},
	...
	set_exchange_rate_label: function() {
		if(cur_frm.doc.from_currency && cur_frm.doc.to_currency) {
			var default_label = __(dontmanage.meta.docfield_map[cur_frm.doctype]["exchange_rate"].label);
