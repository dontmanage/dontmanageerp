...
class TestCurrencyExchange(unittest.TestCase):
	...
	def tearDown(self):
		dontmanage.db.set_value("Accounts Settings", None, "allow_stale", 1)
		self.clear_cache()
	...
	def test_exchange_rate_strict(self, mock_get):
		...
		dontmanage.db.set_value("Accounts Settings", None, "allow_stale", 0)
		dontmanage.db.set_value("Accounts Settings", None, "stale_days", 1)
