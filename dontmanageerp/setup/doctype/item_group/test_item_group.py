...
class TestItem(unittest.TestCase):
	...
	def print_tree(self):
		...
		print(
			json.dumps(dontmanage.db.sql("select name, lft, rgt from `tabItem Group` order by lft"), indent=1)
		)
	...
	def test_delete_leaf(self):
		# for checking later
		parent_item_group = dontmanage.db.get_value(
			"Item Group", "_Test Item Group B - 3", "parent_item_group"
		)
		rgt = dontmanage.db.get_value("Item Group", parent_item_group, "rgt")
	...
	def test_delete_group(self):
		...
		self.assertRaises(
			NestedSetChildExistsError, dontmanage.delete_doc, "Item Group", "_Test Item Group B"
		)
