...
dontmanage.ui.form.on('Transaction Deletion Record', {
	onload: function(frm) {
		if (frm.doc.docstatus == 0) {
			let doctypes_to_be_ignored_array;
			dontmanage.call({
				method: 'dontmanageerp.setup.doctype.transaction_deletion_record.transaction_deletion_record.get_doctypes_to_be_ignored',
				callback: function(r) {
