...
from dontmanageerp.accounts.doctype.cash_flow_mapper.default_cash_flow_mapper import DEFAULT_MAPPERS
...
def create_default_cash_flow_mapper_templates():
	for mapper in DEFAULT_MAPPERS:
		if not dontmanage.db.exists("Cash Flow Mapper", mapper["section_name"]):
			doc = dontmanage.get_doc(mapper)
	...
	dontmanageerp_navbar_items = [
		{
			...
			"item_type": "Route",
			"route": "https://docs.dontmanageerp.com/docs/v14/user/manual/en/introduction",
			"is_standard": 1,
		},
		{
			"item_label": "User Forum",
			"item_type": "Route",
			"route": "https://discuss.dontmanageerp.com",
			"is_standard": 1,
		},
		{
...
def add_app_name():
	dontmanage.db.set_value("System Settings", None, "app_name", "DontManageErp")


def setup_log_settings():
	log_settings = dontmanage.get_single("Log Settings")
