...
class TestTaxes(unittest.TestCase):
	def setUp(self):
		self.company = dontmanage.get_doc(
			{
				"doctype": "Company",
				"company_name": uuid4(),
		...
		self.account = dontmanage.get_doc(
			{
				"doctype": "Account",
				"account_name": uuid4(),
				"account_type": "Tax",
		...
		self.item_group = dontmanage.get_doc(
			{
				"doctype": "Item Group",
		...
		self.item_tax_template = dontmanage.get_doc(
			{
		...
		self.customer = dontmanage.get_doc(
			{
				"doctype": "Customer",
				"customer_name": uuid4(),
		...
		self.supplier = dontmanage.get_doc(
			{
				"doctype": "Supplier",
				"supplier_name": uuid4(),
			...
			doc = dontmanage.get_doc(
				{
					...
					"currency": "USD",
					"schedule_date": dontmanage.utils.nowdate(),
					"delivery_date": dontmanage.utils.nowdate(),
