...
from dontmanageerp.controllers.item_variant import copy_attributes_to_variant, make_variant_item_code
from dontmanageerp.stock.doctype.item.test_item import set_item_variant_settings
...
def make_item_variant():
	dontmanage.delete_doc_if_exists("Item", "_Test Variant Item-XSL", force=1)
...
def make_quality_inspection_template():
	...
	if dontmanage.db.exists("Quality Inspection Template", qc_template):
		return qc_template

	qc = dontmanage.new_doc("Quality Inspection Template")
