...
def validate_item_attribute_value(
	...
	if allow_rename_attribute_value:
		...
		if from_variant:
			...
			).format(dontmanage.bold("Allow Rename Attribute Value"))
...
def find_variant(template, args, variant_item_code=None):
	conditions = [
		"""(iv_attribute.attribute={0} and iv_attribute.attribute_value={1})""".format(
			dontmanage.db.escape(key), dontmanage.db.escape(cstr(value))
		)
	...
	from dontmanageerp.e_commerce.variant_selector.utils import get_item_codes_by_attributes
