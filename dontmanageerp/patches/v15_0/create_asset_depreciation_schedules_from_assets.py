...
def execute():
	dontmanage.reload_doc("assets", "doctype", "Asset Depreciation Schedule")
	dontmanage.reload_doc("assets", "doctype", "Asset Finance Book")
