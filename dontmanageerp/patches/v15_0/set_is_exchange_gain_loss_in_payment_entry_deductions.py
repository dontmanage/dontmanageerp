...
def execute():
	default_exchange_gain_loss_accounts = dontmanage.get_all(
		"Company",
	...
	payment_entry_deduction = dontmanage.qb.DocType("Payment Entry Deduction")

	dontmanage.qb.update(payment_entry_deduction).set(payment_entry_deduction.is_exchange_gain_loss, 1).join(
		payment_entry,
