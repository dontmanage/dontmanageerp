...
def execute():
	...
	finance_books = dontmanage.db.get_all("Finance Book", pluck="name")
...
def correct_value_for_assets_with_manual_depr_entries():
	...
	dontmanage.qb.update(asset).join(asset_details_and_depr_amount_map).on(
