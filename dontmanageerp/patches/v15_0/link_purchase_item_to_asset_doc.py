...
def execute():
	if dontmanage.db.has_column("Asset", "purchase_invoice_item") and dontmanage.db.has_column(
		...
		for asset in assets:
			...
			if asset.purchase_invoice and not asset.purchase_invoice_item:
				...
				dontmanage.db.set_value("Asset", asset.name, "purchase_invoice_item", purchase_invoice_item)
			...
			if asset.purchase_receipt and not asset.purchase_receipt_item:
				...
				dontmanage.db.set_value("Asset", asset.name, "purchase_receipt_item", purchase_receipt_item)
