...
def execute():
	...
	dontmanage.db.sql(""" UPDATE `tabQuotation` set party_name = customer WHERE quotation_to = 'Customer' """)

	dontmanage.reload_doctype("Opportunity")
	dontmanage.db.sql(""" UPDATE `tabOpportunity` set party_name = lead WHERE opportunity_from = 'Lead' """)
	dontmanage.db.sql(
