...
def execute():
	dontmanage.reload_doc("manufacturing", "doctype", "job_card_time_log")

	if dontmanage.db.table_exists("Job Card") and dontmanage.get_meta("Job Card").has_field("actual_start_date"):
		time_logs = []
