import dontmanage
from dontmanage.utils import get_time, getdate, today

from dontmanageerp.accounts.utils import update_gl_entries_after
from dontmanageerp.stock.stock_ledger import update_entries_after
...
def execute():
	...
	dontmanage.flags.warehouse_account_map = {}
	...
	if data:
		for row in dontmanage.get_all("Company", filters={"enable_perpetual_inventory": 1}):
