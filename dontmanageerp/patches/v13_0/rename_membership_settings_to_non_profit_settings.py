...
def execute():
	if dontmanage.db.table_exists("Membership Settings"):
		dontmanage.rename_doc("DocType", "Membership Settings", "Non Profit Settings")
		dontmanage.reload_doctype("Non Profit Settings", force=True)

	if dontmanage.db.table_exists("Non Profit Settings"):
		rename_fields_map = {
