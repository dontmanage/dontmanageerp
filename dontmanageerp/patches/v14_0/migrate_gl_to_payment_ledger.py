...
from dontmanage.query_builder import CustomFunction
from dontmanage.query_builder.custom import ConstantColumn
from dontmanage.query_builder.functions import Count, IfNull
...
def get_columns():
	...
	if dontmanage.db.has_column("Payment Ledger Entry", "remarks"):
...
def execute():
	...
	if dontmanage.reload_doc("accounts", "doctype", "payment_ledger_entry"):
