...
def execute():
	...
	print_formats = dontmanage.get_all("Print Format", {"module": "education", "standard": "Yes"}, pluck="name")
	...
	dashboards = dontmanage.get_all("Dashboard Chart", {"module": "education", "is_standard": 1}, pluck="name")
	for dashboard in dashboards:
