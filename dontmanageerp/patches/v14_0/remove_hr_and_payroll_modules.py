...
def execute():
	...
	doctypes = dontmanage.get_all("DocType", {"module": ("in", ["HR", "Payroll"]), "custom": 0}, pluck="name")
	...
	for dt in ["Web Form", "Dashboard", "Dashboard Chart", "Number Card"]:
		records = dontmanage.get_all(dt, {"module": ("in", ["HR", "Payroll"]), "is_standard": 1}, pluck="name")
