...
def set_series(doctype, value):
	doc = dontmanage.db.exists("Property Setter", {"doc_type": doctype, "property": "autoname"})
	if doc:
		dontmanage.db.set_value("Property Setter", doc, "value", value)
	else:
...
def get_series_to_preserve(doctype):
	series_to_preserve = dontmanage.db.get_value("DocType", doctype, "autoname")
