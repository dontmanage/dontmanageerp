...
def execute():
	warehouse_perm = dontmanage.get_all(
		"User Permission",
	...
	for doctype in ["Sales Invoice", "Delivery Note"]:
		if not dontmanage.get_meta(doctype + " Item").get_field("target_warehouse").hidden:
			continue
	...
	if dontmanage.get_meta("Sales Order Item").get_field("target_warehouse").hidden:
		dontmanage.db.sql(
