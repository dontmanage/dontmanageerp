...
def execute():
	dontmanage.reload_doc("setup", "doctype", "target_detail")
	...
	dontmanage.delete_doc("Report", "Sales Partner-wise Transaction Summary")
	dontmanage.delete_doc("Report", "Sales Person Target Variance Item Group-Wise")
	dontmanage.delete_doc("Report", "Territory Target Variance Item Group-Wise")
