...
from dontmanage.utils import cint, date_diff, flt
...
class FIFOSlots:
	...
	def generate(self) -> dict:
		...
		bundle_wise_serial_nos = dontmanage._dict({})
	...
	def __get_bundle_wise_serial_nos(self) -> dict:
		...
		entry = dontmanage.qb.DocType("Serial and Batch Entry")
	...
	def __get_item_query(self) -> str:
		...
		item = dontmanage.qb.from_("Item").select(
	...
	def __get_warehouse_conditions(self, sle, sle_query) -> str:
		...
		lft, rgt = dontmanage.db.get_value("Warehouse", self.filters.get("warehouse"), ["lft", "rgt"])
