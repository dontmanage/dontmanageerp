...
from dontmanageerp.stock.report.stock_ageing.stock_ageing import FIFOSlots, format_report_data


class TestStockAgeing(DontManageTestCase):
	def setUp(self) -> None:
		self.filters = dontmanage._dict(company="_Test Company", to_date="2021-12-10", ranges=["30", "60", "90"])
	...
	def test_repack_entry_same_item_split_rows(self):
		...
		"""
		sle = [
			dontmanage._dict(  # stock up item
				name="Flask Item",
				actual_qty=500,
