...
def get_voucher_type(doctype, txt, searchfield, start, page_len, filters):
	...
	return dontmanage.get_all("DocField", filters=query_filters, fields=["distinct parent"], as_list=True)
...
def get_serial_nos(doctype, txt, searchfield, start, page_len, filters):
	...
	if filters.get("voucher_no"):
		serial_batch_bundle = dontmanage.get_cached_value(
			"Serial and Batch Bundle",
		...
		return dontmanage.get_all("Serial No", filters=query_filters, as_list=True)
...
def get_batch_nos(doctype, txt, searchfield, start, page_len, filters):
	...
	if filters.get("voucher_no"):
		...
		return dontmanage.get_all("Batch", filters=query_filters, as_list=True)
