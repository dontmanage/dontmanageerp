...
def get_data(filters):
	if not any([filters.warehouse, filters.item_code, filters.item_group]):
		dontmanage.throw(_("Any one of following filters required: warehouse, Item Code, Item Group"))
...
def get_stock_ledger_entries(filters):
	...
	if filters.item_code:
		...
		sle_filters["item_code"] = (
			"in",
			dontmanage.get_all("Item", filters=item_group_filter, pluck="name", order_by=None),
		)
