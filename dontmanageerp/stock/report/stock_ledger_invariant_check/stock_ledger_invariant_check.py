...
from dontmanage.utils import cint, flt, get_link_to_form, parse_json
...
def add_invariant_check_fields(sles, filters):
	...
	incorrect_idx = 0
	precision = dontmanage.get_precision("Stock Ledger Entry", "actual_qty")
	for idx, sle in enumerate(sles):
		...
		if (
			...
			balance_qty = dontmanage.db.get_value("Stock Reconciliation Item", sle.voucher_detail_no, "qty")
		...
		if sle.batch_no:
			sle.use_batchwise_valuation = dontmanage.db.get_value(
