...
def get_incorrect_serial_nos(serial_nos_data):
	...
	total_value = dontmanage._dict({"qty": 0, "valuation_rate": 0, "serial_no": dontmanage.bold(_("Balance"))})

	for _serial_no, data in serial_nos_data.items():
		total_dict = dontmanage._dict({"qty": 0, "valuation_rate": 0, "serial_no": dontmanage.bold(_("Total"))})
