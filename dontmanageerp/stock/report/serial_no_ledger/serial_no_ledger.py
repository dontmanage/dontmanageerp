...
from dontmanageerp.stock.doctype.serial_no.serial_no import get_serial_nos as get_serial_nos_from_sle
from dontmanageerp.stock.stock_ledger import get_stock_ledger_entries
...
def get_data(filters):
	...
	for row in stock_ledgers:
		...
		args.party = (
			dontmanage.db.get_value(row.voucher_type, row.voucher_no, party_field) if party_field else None
		)
