...
dontmanage.query_reports["Reserved Stock"] = {
	filters: [
		{
			fieldname: "company",
			label: __("Company"),
		...
		},
		{
			...
			label: __("From Date"),
			fieldtype: "Date",
			default: dontmanage.datetime.add_months(
		...
		},
		{
			...
			get_options: function () {
				return dontmanage.query_report.get_filter_value("voucher_type");
			},
		},
		{
		...
		},
		{
			...
			get_options: function () {
				return dontmanage.query_report.get_filter_value("from_voucher_type");
			},
		},
		{
