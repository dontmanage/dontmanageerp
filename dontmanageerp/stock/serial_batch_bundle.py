...
from dontmanage.utils import cint, cstr, flt, get_link_to_form, now, nowtime, today
...
class SerialBatchBundle:
	...
	def cancel_serial_and_batch_bundle(self):
		dontmanage.get_cached_doc("Serial and Batch Bundle", self.sle.serial_and_batch_bundle).cancel()
