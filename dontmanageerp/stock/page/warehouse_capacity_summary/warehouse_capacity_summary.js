dontmanage.pages['warehouse-capacity-summary'].on_page_load = function(wrapper) {
	...
	dontmanage.require('item-dashboard.bundle.js', function() {
		$(dontmanage.render_template('warehouse_capacity_summary_header')).appendTo(page.main);

		page.capacity_dashboard = new dontmanageerp.stock.ItemDashboard({
			page_name: "warehouse-capacity-summary",
			page_length: 10,
			parent: page.main,
			sort_by: 'stock_capacity',
			sort_order: 'desc',
			method: 'dontmanageerp.stock.dashboard.warehouse_capacity_dashboard.get_data',
