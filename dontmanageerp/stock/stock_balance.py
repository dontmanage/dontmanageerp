...
import dontmanage
from dontmanage.utils import cstr, flt, now, nowdate, nowtime

from dontmanageerp.controllers.stock_controller import create_repost_item_valuation_entry
...
def set_stock_balance_as_per_serial_no(
	...
	for d in bin:
		...
		sle_doc = dontmanage.get_doc(sle_dict)
