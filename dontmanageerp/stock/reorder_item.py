...
def _reorder_item():
	...
	items_to_consider = dontmanage.db.sql_list(
...
def create_material_request(material_requests):
	...
	def _log_exception(mr):
		if dontmanage.local.message_log:
			...
			exceptions_list.append(dontmanage.get_traceback())
		...
		for company in material_requests[request_type]:
			try:
				...
				for d in items:
					...
					item = dontmanage.get_doc("Item", d.item_code)
					uom = item.stock_uom
...
def send_email_notification(mr_list):
	...
	email_list = dontmanage.db.sql_list(
