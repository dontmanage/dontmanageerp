...
from dontmanage.utils import flt, nowtime
...
class DeprecatedSerialNoValuation:
	...
	def get_incoming_value_for_serial_nos(self, serial_nos):
		...
		for serial_no in serial_nos:
			sn_details = dontmanage.db.get_value("Serial No", serial_no, ["purchase_rate", "company"], as_dict=1)
...
def has_sle_for_serial_nos(item_code):
	serial_nos = dontmanage.db.get_all(
		"Stock Ledger Entry",
		fields=["name"],
