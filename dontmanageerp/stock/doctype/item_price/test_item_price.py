...
from dontmanageerp.stock.doctype.item_price.item_price import ItemPriceDuplicateItem
from dontmanageerp.stock.get_item_details import get_price_list_rate_for, process_args


class TestItemPrice(DontManageTestCase):
	def setUp(self):
		super().setUp()
	...
	def test_duplicate_item(self):
		doc = dontmanage.copy_doc(test_records[0])
		self.assertRaises(ItemPriceDuplicateItem, doc.save)

	def test_addition_of_new_fields(self):
		# Based on https://github.com/dontmanage/dontmanageerp/issues/8456
	...
	def test_price_in_a_qty(self):
		...
		doc = dontmanage.copy_doc(test_records[2])
	...
	def test_prices_at_invalid_date(self):
		...
		doc = dontmanage.copy_doc(test_records[3])
	...
	def test_prices_outside_of_date(self):
		...
		doc = dontmanage.copy_doc(test_records[4])
...
test_records = dontmanage.get_test_records("Item Price")
