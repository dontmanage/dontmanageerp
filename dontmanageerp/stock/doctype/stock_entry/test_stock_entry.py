...
class TestStockEntry(DontManageTestCase):
	...
	def _test_auto_material_request(
		...
		projected_qty = (
			dontmanage.db.get_value("Bin", {"item_code": item_code, "warehouse": warehouse}, "projected_qty")
			or 0
		)
	...
	def test_serial_move(self):
		...
		se.submit()
		self.assertTrue(
			dontmanage.db.get_value("Serial No", serial_no, "warehouse"), "_Test Warehouse 1 - _TC"
		)
