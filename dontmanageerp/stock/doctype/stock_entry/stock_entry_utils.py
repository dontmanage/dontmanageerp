...
def make_stock_entry(**args):
	...
	s = dontmanage.new_doc("Stock Entry")
	...
	if not args.company:
		if args.source:
			args.company = dontmanage.db.get_value("Warehouse", args.source, "company")
		elif args.target:
			args.company = dontmanage.db.get_value("Warehouse", args.target, "company")
	...
	s.company = args.company or dontmanageerp.get_default_company()
	...
	if not args.cost_center:
		args.cost_center = dontmanage.get_value("Company", s.company, "cost_center")

	if not args.expense_account and s.is_opening == "No":
		args.expense_account = dontmanage.get_value("Company", s.company, "stock_adjustment_account")
	...
	if not args.use_serial_batch_fields and (args.serial_no or args.batch_no or args.batches):
		...
		if args.batch_no:
			batches = dontmanage._dict({args.batch_no: args.qty})
		elif args.batches:
