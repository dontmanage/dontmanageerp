...
from dontmanage.utils import add_days, add_to_date, flt, now
...
class TestLandedCostVoucher(DontManageTestCase):
	...
	def test_landed_cost_voucher_for_serialized_item(self):
		...
		serial_no_rate = dontmanage.db.get_value("Serial No", "SN001", "purchase_rate")

		create_landed_cost_voucher("Purchase Receipt", pr.name, pr.company)

		serial_no = dontmanage.db.get_value("Serial No", "SN001", ["warehouse", "purchase_rate"], as_dict=1)
	...
	def test_serialized_lcv_delivered(self):
		...
		serial_no_rate = dontmanage.db.get_value("Serial No", serial_no, "purchase_rate")
		...
		serial_no = dontmanage.db.get_value(
