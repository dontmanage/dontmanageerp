...
from dontmanage.utils import add_to_date, nowdate
...
def create_product_bundle(
	...
	bundle_doc = dontmanage.get_doc({"doctype": "Product Bundle", "new_item_code": bundle})
...
class TestPackedItem(DontManageTestCase):
