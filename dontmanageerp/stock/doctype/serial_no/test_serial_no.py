...
test_records = dontmanage.get_test_records("Serial No")


class TestSerialNo(DontManageTestCase):
	def tearDown(self):
		dontmanage.db.rollback()

	def test_cannot_create_direct(self):
		dontmanage.delete_doc_if_exists("Serial No", "_TCSER0001")
	...
	def test_inter_company_transfer(self):
		...
		serial_no = dontmanage.get_doc("Serial No", serial_nos[0])
	...
	def test_inter_company_transfer_intermediate_cancellation(self):
		...
		sn_doc = dontmanage.get_doc("Serial No", serial_nos[0])
		...
		self.assertRaises(dontmanage.ValidationError, dn.cancel)
		...
		self.assertRaises(dontmanage.ValidationError, se.cancel)
		self.assertRaises(dontmanage.ValidationError, dn.cancel)
		self.assertRaises(dontmanage.ValidationError, pr.cancel)
	...
	def test_auto_fetch(self):
		...
		# expiry date
		dontmanage.db.set_value("Batch", batch1, "expiry_date", "1980-01-01")
