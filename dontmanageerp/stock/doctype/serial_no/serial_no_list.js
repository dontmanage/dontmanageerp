dontmanage.listview_settings['Serial No'] = {
	...
	get_indicator: (doc) => {
		...
		} else if (doc.warranty_expiry_date && dontmanage.datetime.get_diff(doc.warranty_expiry_date, dontmanage.datetime.nowdate()) <= 0) {
