...
$.extend(dontmanageerp.item, {
	...
	show_multiple_variants_dialog: function (frm) {
		...
		function make_and_show_dialog(fields) {
			...
			$($(me.multiple_variant_dialog.$wrapper.find(".form-column")).find(".dontmanage-control")).css(
				"margin-bottom",
				"0px"
			);
			...
			dontmanage.call({
				...
				callback: function (r) {
					...
					if (r.message) {
						...
						dontmanage.msgprint_dialog = dontmanage.msgprint(
...
dontmanage.tour["Item"] = [
	...
	},
	{
		...
		description: __(
			"If you are maintaining stock of this Item in your Inventory, DontManageErp will make a stock ledger entry for each transaction of this item."
		),
	},
	{
