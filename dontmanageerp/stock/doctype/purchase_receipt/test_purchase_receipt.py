...
from dontmanage.utils import add_days, cint, cstr, flt, nowtime, today
...
from dontmanageerp.stock.stock_ledger import SerialNoExistsInFutureTransaction
...
class TestPurchaseReceipt(DontManageTestCase):
	...
	def test_rejected_serial_no(self):
		...
		for serial_no in rejected_serial_nos:
			self.assertEqual(
				dontmanage.db.get_value("Serial No", serial_no, "warehouse"), pr.get("items")[0].rejected_warehouse
			)
	...
	def test_purchase_receipt_with_exchange_rate_difference(self):
		...
		exchange_gain_loss_account = dontmanage.db.get_value(
...
def make_purchase_receipt(**args):
	...
	pr.append(
		"items",
		{
			...
			or dontmanage.get_cached_value("Company", pr.company, "cost_center"),
