...
from dontmanage.utils import add_days, cint, cstr, flt, today
...
from dontmanageerp.stock.doctype.serial_no.serial_no import SerialNoDuplicateError, get_serial_nos
...
class TestPurchaseReceipt(DontManageTestCase):
	...
	def test_batched_serial_no_purchase(self):
		...
		self.assertFalse(dontmanage.db.get_value("Batch", {"item": item.name, "reference_name": pr.name}))
		self.assertFalse(dontmanage.db.get_all("Serial No", {"batch_no": batch_no}))
	...
	def test_duplicate_serial_nos(self):
		...
		serial_nos = dontmanage.db.get_value(
			"Stock Ledger Entry",
	...
	def test_serial_no_supplier(self):
		...
		self.assertEqual(dontmanage.db.get_value("Serial No", pr_row_1_serial_no, "supplier"), pr.supplier)
