...
class DeliveryNote(SellingController):
	...
	def so_required(self):
		...
		if dontmanage.db.get_value("Selling Settings", None, "so_required") == "Yes":
			for d in self.get("items"):
	...
	def validate_warehouse(self):
		...
		for d in self.get_item_list():
			if not d["warehouse"] and dontmanage.db.get_value("Item", d["item_code"], "is_stock_item") == 1:
...
def on_doctype_update():
	dontmanage.db.add_index("Delivery Note", ["customer", "is_return", "return_against"])
