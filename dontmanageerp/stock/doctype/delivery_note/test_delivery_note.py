...
from dontmanage.utils import add_days, cstr, flt, nowdate, nowtime, today
...
class TestDeliveryNote(DontManageTestCase):
	...
	def test_delivery_note_no_gl_entry(self):
		company = dontmanage.db.get_value("Warehouse", "_Test Warehouse - _TC", "company")
	...
	def test_internal_transfer_precision_gle(self):
		...
		self.assertFalse(
			dontmanage.db.exists("GL Entry", {"voucher_no": dn.name, "voucher_type": dn.doctype})
		)
