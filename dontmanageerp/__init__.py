...
def get_default_cost_center(company):
	...
	if company not in dontmanage.flags.company_cost_center:
		dontmanage.flags.company_cost_center[company] = dontmanage.get_cached_value("Company", company, "cost_center")
...
def get_company_currency(company):
	...
	if company not in dontmanage.flags.company_currency:
...
def is_perpetual_inventory_enabled(company):
	...
	if company not in dontmanage.local.enable_perpetual_inventory:
...
def get_default_finance_book(company=None):
	...
	if company not in dontmanage.local.default_finance_book:
...
def get_party_account_type(party_type):
	...
	if party_type not in dontmanage.local.party_account_types:
