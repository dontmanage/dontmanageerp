...
# api/method/dontmanageerp.dontmanageerp_integrations.exotel_integration.handle_incoming_call
# api/method/dontmanageerp.dontmanageerp_integrations.exotel_integration.handle_end_call
# api/method/dontmanageerp.dontmanageerp_integrations.exotel_integration.handle_missed_call
...
def get_call_log(call_payload):
	...
	if dontmanage.db.exists("Call Log", call_log_id):
		return dontmanage.get_doc("Call Log", call_log_id)


def create_call_log(call_payload):
	call_log = dontmanage.new_doc("Call Log")
...
def get_exotel_settings():
	return dontmanage.get_single("Exotel Settings")
