...
from dontmanage.utils.data import add_days, formatdate, today

from dontmanageerp.maintenance.doctype.maintenance_schedule.maintenance_schedule import (
...
# test_records = dontmanage.get_test_records('Maintenance Schedule')
...
class TestMaintenanceSchedule(unittest.TestCase):
	...
	def test_make_schedule(self):
		...
		visit = dontmanage.new_doc("Maintenance Visit")
		...
		visit.save()
		visit.submit()
		ms = dontmanage.get_doc("Maintenance Schedule", ms.name)
...
def make_serial_item_with_serial(item_code):
	...
	active_serials = dontmanage.db.get_all("Serial No", {"status": "Active", "item_code": item_code})
...
def make_maintenance_schedule(**args):
	ms = dontmanage.new_doc("Maintenance Schedule")
