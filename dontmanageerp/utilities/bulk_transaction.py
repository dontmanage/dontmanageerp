...
def check_logger_doc_exists(log_date):
	return dontmanage.db.exists("Bulk Transaction Log", log_date)


def get_logger_doc(log_date):
	return dontmanage.get_doc("Bulk Transaction Log", log_date)


def create_logger_doc():
	log_doc = dontmanage.new_doc("Bulk Transaction Log")
