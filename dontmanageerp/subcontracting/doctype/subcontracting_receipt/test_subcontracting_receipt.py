...
class TestSubcontractingReceipt(DontManageTestCase):
	...
	def test_available_qty_for_consumption(self):
		...
		scr = make_subcontracting_receipt(sco.name)
		scr.save()
		self.assertRaises(dontmanage.ValidationError, scr.submit)
	...
	def test_subcontracting_over_receipt(self):
		...
		from dontmanageerp.subcontracting.doctype.subcontracting_order.test_subcontracting_order import (
			make_subcontracted_item,
		)
	...
	def test_auto_create_purchase_receipt(self):
		...
		self.assertTrue(dontmanage.db.get_value("Purchase Receipt", {"subcontracting_receipt": scr.name}))
