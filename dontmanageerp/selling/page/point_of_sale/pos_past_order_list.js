dontmanageerp.PointOfSale.PastOrderList = class {
	...
	make_filter_section() {
		...
		this.status_field = dontmanage.ui.form.make_control({
			df: {
	...
	refresh_list() {
		...
		return dontmanage.call({
			method: "dontmanageerp.selling.page.point_of_sale.point_of_sale.get_past_order_list",
			freeze: true,
			...
			`<div class="invoice-wrapper" data-invoice-name="${escape(invoice.name)}">
				<div class="invoice-name-date">
					...
					<div class="invoice-date">
						...
						${dontmanage.ellipsis(invoice.customer, 20)}
					</div>
				</div>
