...
class TestQuotation(DontManageTestCase):
	...
	def test_shopping_cart_without_website_item(self):
		if dontmanage.db.exists("Website Item", {"item_code": "_Test Item Home Desktop 100"}):
			dontmanage.get_last_doc("Website Item", {"item_code": "_Test Item Home Desktop 100"}).delete()
