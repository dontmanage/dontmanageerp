...
class TestSalesOrder(DontManageTestCase):
	@classmethod
	def setUpClass(cls):
		super().setUpClass()
	...
	def test_update_child_removing_item(self):
		...
		self.assertRaises(
			dontmanage.ValidationError, update_child_qty_rate, "Sales Order", trans_item, so.name
		)
	...
	def test_warehouse_user(self):
		...
		dontmanage.permissions.remove_user_permission(
...
def get_reserved_qty(item_code="_Test Item", warehouse="_Test Warehouse - _TC"):
	return flt(
		dontmanage.db.get_value("Bin", {"item_code": item_code, "warehouse": warehouse}, "reserved_qty")
	)
...
def make_sales_order_workflow():
	...
	dontmanage.get_doc(dict(doctype="Role", role_name="Test Junior Approver")).insert(
