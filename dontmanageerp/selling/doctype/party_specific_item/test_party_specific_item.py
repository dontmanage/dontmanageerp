...
class TestPartySpecificItem(DontManageTestCase):
	def setUp(self):
		self.customer = dontmanage.get_last_doc("Customer")
		self.supplier = dontmanage.get_last_doc("Supplier")
		self.item = dontmanage.get_last_doc("Item")
