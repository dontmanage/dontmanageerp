...
def get_data():
	sales_order_entry = dontmanage.db.sql(
		"""
		SELECT
			so_item.item_code,
			so_item.item_name,
...
def get_items_with_product_bundle(item_list):
	bundled_items = dontmanage.get_all(
