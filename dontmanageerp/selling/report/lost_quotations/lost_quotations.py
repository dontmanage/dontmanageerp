...
from dontmanage.query_builder.functions import Coalesce, Count, Round, Sum
from dontmanage.utils.data import get_timespan_date_range
...
def get_data(
	...
	if group_by == "Lost Reason":
		...
		dimension = dontmanage.qb.DocType("Quotation Lost Reason Detail")
	elif group_by == "Competitor":
		fieldname = "competitor"
		dimension = dontmanage.qb.DocType("Competitor Detail")
	else:
		dontmanage.throw(_("Invalid Group By"))

	q = dontmanage.qb.DocType("Quotation")
