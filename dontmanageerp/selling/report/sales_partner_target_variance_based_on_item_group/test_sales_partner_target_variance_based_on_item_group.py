...
from dontmanageerp.selling.report.sales_partner_target_variance_based_on_item_group.sales_partner_target_variance_based_on_item_group import (
	execute,
)
from dontmanageerp.selling.report.sales_person_target_variance_based_on_item_group.test_sales_person_target_variance_based_on_item_group import (
	create_sales_target_doc,
	create_target_distribution,
)


class TestSalesPartnerTargetVarianceBasedOnItemGroup(DontManageTestCase):
	def setUp(self):
