...
dontmanage.query_reports["Sales Analytics"] = {
	"filters": [
		{
			fieldname: "tree_type",
			label: __("Tree Type"),
		...
		return Object.assign(options, {
			...
			events: {
				onCheckRow: function (data) {
					...
					const tree_type = dontmanage.query_report.filters[0].value;
					if (data_doctype != tree_type) return;

					const row_name = data[2].content;
					const raw_data = dontmanage.query_report.chart.data;
					...
					const new_options = Object.assign({}, dontmanage.query_report.chart_options, {data: new_data});
					dontmanage.query_report.render_chart(new_options);
