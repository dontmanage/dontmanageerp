...
from dontmanageerp.selling.report.sales_person_target_variance_based_on_item_group.sales_person_target_variance_based_on_item_group import (
	execute,
)


class TestSalesPersonTargetVarianceBasedOnItemGroup(DontManageTestCase):
	def setUp(self):
...
def create_target_distribution(fiscal_year):
	distribution = dontmanage.new_doc("Monthly Distribution")
...
def create_sales_target_doc(
	...
	sales_target_doc = dontmanage.new_doc(sales_field_dt)
