...
dontmanage.ui.form.on(cur_frm.doctype, {
	...
	applicant: function(frm) {
		...
		if (frm.doc.applicant) {
			dontmanage.model.with_doc(frm.doc.applicant_type, frm.doc.applicant, function() {
				var applicant = dontmanage.model.get_doc(frm.doc.applicant_type, frm.doc.applicant);
