...
def get_active_loan_details(filters):
	...
	currency = dontmanageerp.get_company_currency(filters.get("company"))
...
def get_interest_accruals(loans, filters):
	...
	interest_accruals = dontmanage.get_all(
...
def get_penal_interest_rate_map():
	return dontmanage._dict(
		dontmanage.get_all("Loan Type", fields=["name", "penalty_interest_rate"], as_list=1)
	)
