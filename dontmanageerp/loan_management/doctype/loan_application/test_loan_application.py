...
from dontmanageerp.loan_management.doctype.loan.test_loan import create_loan_accounts, create_loan_type
...
class TestLoanApplication(unittest.TestCase):
	...
	def test_loan_totals(self):
		loan_application = dontmanage.get_doc("Loan Application", {"applicant": self.applicant})
